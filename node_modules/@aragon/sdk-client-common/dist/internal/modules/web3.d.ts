...
import { FrameworkContractsNames, NonFrameworkContractsNames, SupportedNetworks } from "@aragon/osx-commons-configs";
export declare class Web3Module implements IClientWeb3Core {
    ...
    /** FRAMEWORK ADDRESSES */
    getAddress(addressName: FrameworkContractsNames | NonFrameworkContractsNames): string;
}
