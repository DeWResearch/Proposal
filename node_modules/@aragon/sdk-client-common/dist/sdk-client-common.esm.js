import { getNetwork as getNetwork$1, JsonRpcProvider } from '@ethersproject/providers';
import { Client, ClientError as ClientError$1 } from '@aragon/sdk-ipfs';
import { gql, GraphQLClient, ClientError } from 'graphql-request';
import { isAddress } from '@ethersproject/address';
import { Interface, defaultAbiCoder } from '@ethersproject/abi';
import { id } from '@ethersproject/hash';
import { PluginSetupProcessor__factory, PluginRepo__factory } from '@aragon/osx-ethers';
import { keccak256 } from '@ethersproject/keccak256';
import { toUtf8Bytes } from '@ethersproject/strings';
import { hexZeroPad } from '@ethersproject/bytes';
import { Zero } from '@ethersproject/constants';
import { getNetworkByChainId, getNetworkByNameOrAlias, getNetworkAlias, SupportedAliases, getNetworkDeploymentForVersion, SupportedVersions, networks, FrameworkContractsNames, getNetworkNameByAlias, NonFrameworkContractsNames, getNetworkByAlias } from '@aragon/osx-commons-configs';
import { Contract } from '@ethersproject/contracts';
import { mixed, string, array, object, number } from 'yup';
...
var QueryStatus = /*#__PURE__*/gql(_templateObject$1 || (_templateObject$1 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n{\n  _meta{\n    deployment\n  }\n}\n"])));

var _templateObject;
var QueryIPlugin = /*#__PURE__*/gql(_templateObject || (_templateObject = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery IPlugin($address: ID!, $where: IPlugin_filter!) {\n\tiplugin(id:$address, where:$where) {\n    installations(where:{state: Installed}) {\n      appliedPreparation {\n        helpers\n        pluginRepo {\n          id\n        }\n      }\n     \tappliedVersion {\n        metadata\n        build\n        release {\n          release\n        }\n      }\n    }   \n  }\n}\n"])));
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 5:
          ...
          networkName = (_getNetworkByNameOrAl = getNetworkByNameOrAlias(ethers5NetworkName)) == null ? void 0 : _getNetworkByNameOrAl.name;
          if (networkName) {
            _context3.next = 9;
            break;
          }
        ...
        case 9:
          ...
          pluginRepo = PluginRepo__factory.connect(params.pluginRepo, provider);
          _context3.next = 14;
        ...
        case 19:
          ...
          data = defaultAbiCoder.encode(getNamedTypesFromMetadata(installationAbi), installationParams); // connect to psp contract
          deployment = getNetworkDeploymentForVersion(networkName, SupportedVersions.V1_3_0);
          if (deployment) {
            _context3.next = 24;
            break;
          }
        ...
        case 24:
          pspContract = PluginSetupProcessor__factory.connect(deployment[FrameworkContractsNames.PLUGIN_SETUP_PROCESSOR].address, provider);
          _context3.next = 27;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          pluginRepo = PluginRepo__factory.connect(params.pluginRepo, signer);
          _context.next = 8;
        ...
        case 13:
          ...
          data = defaultAbiCoder.encode(getNamedTypesFromMetadata(installationAbi), installationParams); // connect to psp contract
          pspContract = PluginSetupProcessor__factory.connect(params.pluginSetupProcessorAddress, signer);
          _context.next = 18;
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 10:
          ...
          data = defaultAbiCoder.encode(getNamedTypesFromMetadata(updateAbi), updateParams);
...
function getNetwork(networkish) {
  var network = null;
  try {
    network = getNetwork$1(networkish);
  } catch (_unused) {}
  try {
    ...
    case "number":
      {
        ...
        var ethers5Alias = getNetworkAlias(SupportedAliases.ETHERS_5, aragonNetwork.name);
        var networkDeployment = getNetworkDeploymentForVersion(aragonNetwork.name, SupportedVersions.V1_3_0);
...
function getDefaultIpfsNodes(network) {
  return networks[network].isTestnet ? IPFS_ENDPOINTS.test : IPFS_ENDPOINTS.prod;
}
...
var contractNames = /*#__PURE__*/[].concat( /*#__PURE__*/Object.values(FrameworkContractsNames), /*#__PURE__*/Object.values(NonFrameworkContractsNames));
...
var ContextCore = /*#__PURE__*/function () {
  ...
  _proto.setNetworkDefaults = function setNetworkDefaults() {
    // check network
    var networkName = getNetworkNameByAlias(this.network.name);
    if (!networkName) {
    ...
    for (var _iterator2 = _createForOfIteratorHelperLoose(contractNames), _step2; !(_step2 = _iterator2()).done;) {
      ...
      if (!this.overriden[contractName]) {
        ...
        // get deployment
        var deployment = getNetworkDeploymentForVersion(networkName, SupportedVersions.V1_3_0);
        ...
        if (contractName === NonFrameworkContractsNames.ENS_REGISTRY && !contractAddress) {
...
var Web3Module = /*#__PURE__*/function () {
  ...
  _proto.getNetworkName = function getNetworkName() {
    var network = getNetworkByAlias(this.context.network.name);
    if (!network) {
  ...
  _proto.getAddress = function getAddress(addressName) {
    var address = this.context.getAddress(addressName);
...
var BigintSchema = /*#__PURE__*/mixed().test("isBigint", new InvalidParameter("bigint").message, function (value) {
  return typeof value === "bigint";
});
var AddressOrEnsSchema = /*#__PURE__*/string().notRequired().test("isAddressOrEns", new InvalidAddressOrEnsError().message, function (value) {
  return value ? isAddress(value) || isEnsName(value) : true;
});
var AddressOrEnsWithoutAnySchema = /*#__PURE__*/string().notRequired().test("isAddressOrEnsWithoutAny", new InvalidAddressOrEnsError().message, function (value) {
  return value ? (isAddress(value) || isEnsName(value)) && value !== ANY_ADDRESS : true;
});
var VersionTagSchema = /*#__PURE__*/object({
  build: /*#__PURE__*/number().moreThan(0).required(),
  release: /*#__PURE__*/number().moreThan(0).required()
});
var AbiSchema = /*#__PURE__*/array().notRequired().test("isValidAbi", new InvalidContractAbiError().message,
// TODO: validate abi
function () {
  return true;
});
var Uint8ArraySchema = /*#__PURE__*/mixed().test("isUint8Array", new InvalidParameter("Uint8Array").message, function (value) {
  return value ? value instanceof Uint8Array : true;
});
var IpfsUriSchema = /*#__PURE__*/string().test("isIpfsUri", new InvalidCidError().message, function (value) {
  return value ? isIpfsUri(value) : true;
});
var SubdomainSchema = /*#__PURE__*/string().test("isSubdomain", new InvalidSubdomainError().message, function (value) {
  return value ? isSubdomain(value) : true;
});
var PaginationSchema = /*#__PURE__*/object({
  skip: /*#__PURE__*/number().min(0).notRequired(),
  limit: /*#__PURE__*/number().min(1).notRequired(),
  direction: /*#__PURE__*/string().oneOf(["asc", "desc"]).notRequired()
});
var PrepareUninstallationSchema = /*#__PURE__*/object({
  daoAddressOrEns: /*#__PURE__*/AddressOrEnsSchema.required(),
  pluginAddress: /*#__PURE__*/AddressOrEnsSchema.required(),
  pluginInstallationIndex: /*#__PURE__*/number().notRequired().min(0),
  uninstallationParams: /*#__PURE__*/array().notRequired(),
  uninstallationAbi: /*#__PURE__*/AbiSchema.notRequired()
});
var MultiTargetPermissionSchema = /*#__PURE__*/object({
  operation: /*#__PURE__*/number().required().oneOf([0, 1, 2]),
  permissionId: /*#__PURE__*/string().required(),
  where: /*#__PURE__*/AddressOrEnsWithoutAnySchema.required(),
  who: /*#__PURE__*/AddressOrEnsWithoutAnySchema.required(),
  condition: /*#__PURE__*/string().notRequired()
});
var PrepareInstallationSchema = /*#__PURE__*/object({
  daoAddressOrEns: /*#__PURE__*/AddressOrEnsSchema.required(),
  pluginRepo: /*#__PURE__*/AddressOrEnsSchema.required(),
  version: /*#__PURE__*/VersionTagSchema.notRequired(),
  installationParams: /*#__PURE__*/array().notRequired(),
  installationAbi: /*#__PURE__*/AbiSchema.notRequired()
});
var PluginInstallItemSchema = /*#__PURE__*/object({
  id: /*#__PURE__*/AddressOrEnsSchema.required(),
  data: /*#__PURE__*/Uint8ArraySchema.required()
});
var ApplyUninstallationSchema = /*#__PURE__*/object({
  pluginAddress: /*#__PURE__*/AddressOrEnsSchema.required(),
  pluginRepo: /*#__PURE__*/AddressOrEnsSchema.required(),
  versionTag: /*#__PURE__*/VersionTagSchema.required(),
  permissions: /*#__PURE__*/array(MultiTargetPermissionSchema).required()
});
var ApplyInstallationSchema = /*#__PURE__*/ApplyUninstallationSchema.concat( /*#__PURE__*/object({
  helpers: /*#__PURE__*/array(AddressOrEnsSchema).required()
}));
var IsMemberSchema = /*#__PURE__*/object({
  address: /*#__PURE__*/AddressOrEnsSchema.required(),
  pluginAddress: /*#__PURE__*/AddressOrEnsSchema.required(),
  blockNumber: /*#__PURE__*/number().notRequired()
});

export { AbiSchema, AddressOrEnsSchema, AddressOrEnsWithoutAnySchema, AlwaysFailingProposalError, AmountMismatchError, ApplyInstallationSchema, ApplyUninstallationSchema, BigintSchema, CannotEstimateGasError, ClientCore, ClientNotInitializedError, Context, ContextCore, ContractNotDeployedError, DaoCreationError, DataDecodingError, DepositNativeTokenError, EMPTY_PROPOSAL_METADATA_LINK, ENS_REGEX, EmptyMultiUriError, FailedDepositError, GraphQLError, HEX_STRING_REGEX, IPFS_CID_REGEX, IPFS_ENDPOINTS, IPFS_URI_REGEX, InstallationNotFoundError, InvalidActionError, InvalidAddressError, InvalidAddressOrEnsError, InvalidArraySizeError, InvalidBitMapValueError, InvalidCidError, InvalidContractAbiError, InvalidContractAddressError, InvalidDigitsValueError, InvalidEnsError, InvalidGasEstimationFactorError, InvalidParameter, InvalidPermissionOperationType, InvalidPrecisionError, InvalidPrepareUninstallationAbiError, InvalidPromiseError, InvalidProposalIdError, InvalidProposalStatusError, InvalidRatioValueError, InvalidSubdomainError, InvalidTimeoutError, InvalidVersionError, InvalidVotingModeError, IpfsError, IpfsFetchError, IpfsPinError, IpfsUriSchema, IsMemberSchema, MULTI_FETCH_TIMEOUT, MissingExecPermissionError, MissingMetadataError, MultiTargetPermissionSchema, MultiUri, NoDaoFactory, NoDaoRegistry, NoNodesAvailableError, NoPluginRepoRegistry, NoProviderError, NoSignerError, NoTokenAddress, NotAContractError, NotImplementedError, OSX_PROPOSAL_ID_REGEX, PaginationSchema, PermissionIds, PermissionOperationType, Permissions, PluginInstallItemSchema, PluginInstallationPreparationError, PluginUninstallationPreparationError, PluginUpdatePreparationError, PrepareInstallationSchema, PrepareInstallationStep, PrepareUninstallationSchema, PrepareUninstallationSteps, PrepareUpdateStep, ProposalCreationError, ProposalNotFoundError, ProposalStatus, SUBDOMAIN_REGEX, SizeMismatchError, SortDirection, SubdomainSchema, TimeoutError, TokenType, UNAVAILABLE_PROPOSAL_METADATA, UNSUPPORTED_PROPOSAL_METADATA_LINK, Uint8ArraySchema, UnexpectedActionError, UnsupportedNetworkError, UnsupportedProtocolError, UpdateAllowanceError, ValueOutOfRangeError, VersionTagSchema, bitmapToBoolArray, boolArrayToBitmap, bytesToHex, decodeProposalId, decodeRatio, encodeProposalId, encodeRatio, ensure0x, findLog, getCompactProposalId, getDefaultGraphqlNodes, getDefaultIpfsNodes, getExtendedProposalId, getFunctionFragment, getInterfaceId, getNamedTypesFromMetadata, getNetwork, hexToBytes, isEnsName, isIpfsUri, isProposalId, isSubdomain, prepareGenericInstallation, prepareGenericInstallationEstimation, prepareGenericUpdate, prepareGenericUpdateEstimation, promiseWithTimeout, resolveIpfsCid, runAndRetry, strip0x };
//# sourceMappingURL=sdk-client-common.esm.js.map
