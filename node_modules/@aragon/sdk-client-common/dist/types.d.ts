...
import { GraphQLContextParams, GraphQLContextState, IpfsContextParams, IpfsContextState, Web3ContextParams, Web3ContextState } from "./internal";
export type ContextParams = Web3ContextParams & IpfsContextParams & GraphQLContextParams;
export type ContextState = Web3ContextState & IpfsContextState & GraphQLContextState;
...
export declare enum PrepareUpdateStep {
    PREPARING = "preparing",
    DONE = "done"
}
