...
import { AddAddressesParams, ApproveMultisigProposalParams, ApproveProposalStepValue, CanApproveParams, CreateMultisigProposalParams, MultisigPluginPrepareInstallationParams, MultisigPluginPrepareUpdateParams, MultisigProposal, MultisigProposalListItem, MultisigVotingSettings, RemoveAddressesParams, UpdateMultisigVotingSettingsParams } from "../types";
export interface IMultisigClientMethods {
    ...
    getVotingSettings: (addressOrEns: string, blockNumber?: number) => Promise<MultisigVotingSettings>;
...
export interface IMultisigClientEstimation {
    ...
    prepareUpdate: (params: MultisigPluginPrepareUpdateParams) => Promise<GasFeeEstimation>;
}
