import { DaoAction, GasFeeEstimation, InterfaceParams, IsMemberParams, PrepareInstallationStepValue, PrepareUpdateStepValue, ProposalMetadata } from "@aragon/sdk-client-common";
import { CanVoteParams, CreateMajorityVotingProposalParams, ExecuteProposalStepValue, MembersQueryParams, ProposalCreationStepValue, ProposalQueryParams, VoteProposalParams, VoteProposalStepValue, VotingSettings } from "../../client-common";
import { AddresslistVotingPluginPrepareInstallationParams, AddresslistVotingPluginPrepareUpdateParams, AddresslistVotingProposal, AddresslistVotingProposalListItem } from "../types";
export interface IAddresslistVotingClientMethods {
    ...
    prepareUpdate: (params: AddresslistVotingPluginPrepareUpdateParams) => AsyncGenerator<PrepareUpdateStepValue>;
...
export interface IAddresslistVotingClientEstimation {
    ...
    prepareUpdate(params: AddresslistVotingPluginPrepareUpdateParams): Promise<GasFeeEstimation>;
}
