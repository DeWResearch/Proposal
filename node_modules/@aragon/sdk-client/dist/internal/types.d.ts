...
export type SubgraphBalance = SubgraphErc20Balance | SubgraphErc721Balance | SubgraphNativeBalance | SubgraphErc1155Balance;
...
export type SubgraphTransferListItem = SubgraphErc20TransferListItem | SubgraphErc721TransferListItem | SubgraphNativeTransferListItem | SubgraphErc1155TransferListItem;
...
export declare enum SubgraphPluginPermissionOperation {
    GRANT = "Grant",
    REVOKE = "Revoke",
    GRANT_WITH_CONDITION = "GrantWithCondition"
}
export declare enum ProposalActionTypes {
