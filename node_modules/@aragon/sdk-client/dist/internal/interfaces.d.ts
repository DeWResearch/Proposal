import { ApplyInstallationParams, ApplyUninstallationParams, ApplyUpdateParams, DaoAction, DecodedApplyInstallationParams, DecodedApplyUninstallationParams, DecodedApplyUpdateParams, GasFeeEstimation, InterfaceParams, PrepareInstallationParams, PrepareInstallationStepValue, PrepareUninstallationParams, PrepareUninstallationStepValue, PrepareUpdateParams, PrepareUpdateStepValue } from "@aragon/sdk-client-common";
import { AssetBalance, CreateDaoParams, DaoBalancesQueryParams, DaoCreationStepValue, DaoDepositStepValue, DaoDetails, DaoListItem, DaoMetadata, DaoQueryParams, DaoUpdateDecodedParams, DaoUpdateParams, DaoUpdateProposalValidity, DepositParams, GrantPermissionDecodedParams, GrantPermissionParams, GrantPermissionWithConditionParams, HasPermissionParams, InitializeFromParams, PluginPreparationListItem, PluginPreparationQueryParams, PluginQueryParams, PluginRepo, PluginRepoListItem, PluginUpdateProposalValidity, RegisterStandardCallbackParams, RevokePermissionDecodedParams, RevokePermissionParams, SetAllowanceParams, SetAllowanceStepValue, Transfer, TransferQueryParams, UpgradeToAndCallParams, WithdrawParams } from "../types";
...
export interface IClientMethods {
    ...
    getPluginPreparations(params: PluginPreparationQueryParams): Promise<PluginPreparationListItem[]>;
}
export interface IClientEncoding {
    ...
    applyUpdateAndPermissionsActionBlock: (daoAddressOrEns: string, params: ApplyUpdateParams) => DaoAction[];
    initializeFromAction: (daoAddressOrEns: string, params: InitializeFromParams) => DaoAction;
    daoUpdateAction: (daoAddressOrEns: string, params: DaoUpdateParams) => Promise<DaoAction>;
}
export interface IClientDecoding {
    ...
    daoUpdateAction: (data: Uint8Array) => DaoUpdateDecodedParams;
}
export interface IClientEstimation {
    ...
    prepareUpdate: (params: PrepareUpdateParams) => Promise<GasFeeEstimation>;
}
