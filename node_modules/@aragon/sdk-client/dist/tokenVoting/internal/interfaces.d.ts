...
import { DelegateTokensParams, DelegateTokensStepValue, Erc20TokenDetails, Erc20WrapperTokenDetails, Erc721TokenDetails, MintTokenParams, TokenVotingMember, TokenVotingPluginPrepareInstallationParams, TokenVotingPluginPrepareUpdateParams, TokenVotingProposal, TokenVotingProposalListItem, UndelegateTokensStepValue, UnwrapTokensParams, UnwrapTokensStepValue, WrapTokensParams, WrapTokensStepValue } from "../types";
...
export interface ITokenVotingClientMethods {
    ...
    getMembers: (params: TokenVotingMembersQueryParams) => Promise<TokenVotingMember[]>;
    ...
    getToken: (pluginAddress: string) => Promise<Erc20TokenDetails | Erc20WrapperTokenDetails | Erc721TokenDetails | null>;
...
export interface ITokenVotingClientEstimation {
    ...
    prepareUpdate: (params: TokenVotingPluginPrepareUpdateParams) => Promise<GasFeeEstimation>;
}
