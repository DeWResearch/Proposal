...
import { ContractVotingSettings, MembersQueryParamsBase, SubgraphAction, SubgraphProposalBase, SubgraphVoterListItemBase, VotingMode } from "../../client-common";
...
export declare enum TokenVotingMembersSortBy {
    ADDRESS = "address",
    BALANCE = "balance",
...
export declare enum TokenVotingTokenCompatibility {
