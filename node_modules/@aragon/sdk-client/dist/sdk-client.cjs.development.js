...
var ERC20_json = require('@openzeppelin/contracts/build/contracts/ERC20.json');
var ERC721_json = require('@openzeppelin/contracts/build/contracts/ERC721.json');
var ERC1155_json = require('@openzeppelin/contracts/build/contracts/ERC1155.json');
var graphqlRequest = require('graphql-request');
var keccak256 = require('@ethersproject/keccak256');
var strings = require('@ethersproject/strings');
var sdkClientCommon = require('@aragon/sdk-client-common');
var yup = require('yup');
var address = require('@ethersproject/address');
var hash = require('@ethersproject/hash');
var osxCommonsConfigs = require('@aragon/osx-commons-configs');
var IVotes_json = require('@openzeppelin/contracts/build/contracts/IVotes.json');
var IVotesUpgradeable_json = require('@openzeppelin/contracts-upgradeable/build/contracts/IVotesUpgradeable.json');
var ERC165_json = require('@openzeppelin/contracts/build/contracts/ERC165.json');
...
var QueryPluginPreparations = /*#__PURE__*/graphqlRequest.gql(_templateObject4 || (_templateObject4 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery PluginPreparations($where: PluginPreparation_filter!) {\n  pluginPreparations(where: $where){\n    data\n  }\n}\n"])));
var QueryPluginPreparationsExtended = /*#__PURE__*/graphqlRequest.gql(_templateObject5 || (_templateObject5 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery PluginPreparations($where: PluginPreparation_filter!, $limit: Int!, $skip: Int!, $direction: OrderDirection!, $sortBy: PluginPreparation_orderBy!) {\n  pluginPreparations(where: $where, first: $limit, skip: $skip, orderDirection: $direction, orderBy: $sortBy){\n    id\n    type\n    creator\n    dao {\n      id\n    }\n    pluginRepo {\n      id\n      subdomain\n    }\n    pluginVersion{\n      build\n      release{\n        release\n      }\n    }\n    pluginAddress\n    permissions {\n      id\n      operation\n      where\n      who\n      condition\n    }\n    helpers\n    data\n  }\n}\n"])));
var QueryPluginInstallations = /*#__PURE__*/graphqlRequest.gql(_templateObject6 || (_templateObject6 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  query PluginInstallations($where: PluginInstallation_filter!) {\n    pluginInstallations(where: $where) {\n      id\n    }\n  }"])));

var _templateObject$a;
var QueryIProposal = /*#__PURE__*/graphqlRequest.gql(_templateObject$a || (_templateObject$a = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery IProposal($id: String!) {\n    iproposal(id: $id) {\n        dao {\n            id\n        }\n        allowFailureMap\n        actions {\n            to\n            value\n            data\n        }\n    }\n}\n"])));

exports.DaoCreationSteps = void 0;
...
exports.AssetBalanceSortBy = void 0;
...
exports.ProposalSettingsErrorCause = void 0;
...
})(exports.ProposalSettingsErrorCause || (exports.ProposalSettingsErrorCause = {}));
exports.PluginUpdateProposalInValidityCause = void 0;
...
})(exports.PluginUpdateProposalInValidityCause || (exports.PluginUpdateProposalInValidityCause = {}));
exports.DaoUpdateProposalInvalidityCause = void 0;
...
})(exports.DaoUpdateProposalInvalidityCause || (exports.DaoUpdateProposalInvalidityCause = {}));
exports.PluginPreparationType = void 0;
...
})(exports.PluginPreparationType || (exports.PluginPreparationType = {}));
exports.PluginPreparationSortBy = void 0;
(function (PluginPreparationSortBy) {
  PluginPreparationSortBy["ID"] = "id";
})(exports.PluginPreparationSortBy || (exports.PluginPreparationSortBy = {}));
...
var AVAILABLE_FUNCTION_SIGNATURES$3 = [/*#__PURE__*/new contracts.Contract(constants.AddressZero, ERC20_json.abi)["interface"].getFunction("transfer").format("minimal"), /*#__PURE__*/new contracts.Contract(constants.AddressZero, ERC721_json.abi)["interface"].getFunction("safeTransferFrom(address,address,uint256)").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("grant").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("grantWithCondition").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("revoke").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("setMetadata").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("setDaoURI").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("registerStandardCallback").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("setSignatureValidator").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("upgradeTo").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("upgradeToAndCall").format("minimal")];
...
var UPDATE_PLUGIN_SIGNATURES = [/*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("grant").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("revoke").format("minimal"), /*#__PURE__*/osxEthers.PluginSetupProcessor__factory.createInterface().getFunction("applyUpdate").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("upgradeTo").format("minimal"), /*#__PURE__*/osxEthers.DAO__factory.createInterface().getFunction("upgradeToAndCall").format("minimal")];
...
var CreateDaoSchema = /*#__PURE__*/yup.object({
  metadataUri: /*#__PURE__*/sdkClientCommon.IpfsUriSchema.required(),
  daoUri: /*#__PURE__*/yup.string().url().notRequired(),
  ensSubdomain: /*#__PURE__*/sdkClientCommon.SubdomainSchema.notRequired(),
  trustedForwarder: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.notRequired(),
  plugins: /*#__PURE__*/yup.array(sdkClientCommon.PluginInstallItemSchema).min(1).required()
});
var DaoMetadataSchema = /*#__PURE__*/yup.object({
  name: /*#__PURE__*/yup.string().required(),
  description: /*#__PURE__*/yup.string().required(),
  avatar: /*#__PURE__*/yup.mixed().test(function (item) {
    return [sdkClientCommon.IpfsUriSchema, yup.string().url()].some(function (schema) {
      return schema.strict().isValidSync(item);
    });
  }).notRequired(),
  links: /*#__PURE__*/yup.array(yup.object({
    name: yup.string().required(),
    url: yup.string().required()
  })).required()
});
var DepositEthSchema = /*#__PURE__*/yup.object({
  type: /*#__PURE__*/yup.string().required().oneOf(["native"]),
  daoAddressOrEns: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  amount: /*#__PURE__*/sdkClientCommon.BigintSchema.required()
});
var DepositErc20Schema = /*#__PURE__*/yup.object({
  type: /*#__PURE__*/yup.string().required().oneOf(["erc20"]),
  daoAddressOrEns: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  tokenAddress: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  amount: /*#__PURE__*/sdkClientCommon.BigintSchema.required()
});
var DepositErc721Schema = /*#__PURE__*/yup.object({
  type: /*#__PURE__*/yup.string().required().oneOf(["erc721"]),
  daoAddressOrEns: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  tokenAddress: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  tokenId: /*#__PURE__*/sdkClientCommon.BigintSchema.required()
});
var DepositErc1155Schema = /*#__PURE__*/yup.object({
  type: yup.string().required().oneOf(["erc1155"]),
  daoAddressOrEns: sdkClientCommon.AddressOrEnsSchema.required(),
  tokenAddress: sdkClientCommon.AddressOrEnsSchema.required(),
  tokenIds: yup.array(sdkClientCommon.BigintSchema).required().min(1),
  amounts: yup.array(sdkClientCommon.BigintSchema).required().min(1)
}).test("isSameLength", new sdkClientCommon.SizeMismatchError("tokenIds", "amounts").message, function (value) {
  var v = value;
  return v.tokenIds && v.amounts ? v.tokenIds.length === v.amounts.length : true;
});
var SetAllowanceSchema = /*#__PURE__*/yup.object({
  tokenAddress: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  amount: /*#__PURE__*/sdkClientCommon.BigintSchema.required(),
  spender: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required()
});
var HasPermissionSchema = /*#__PURE__*/yup.object({
  who: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  where: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  permission: /*#__PURE__*/yup.string().required(),
  daoAddressOrEns: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  data: /*#__PURE__*/sdkClientCommon.Uint8ArraySchema.notRequired()
});
var DaoQuerySchema = /*#__PURE__*/sdkClientCommon.PaginationSchema.concat( /*#__PURE__*/yup.object({
  sortBy: /*#__PURE__*/yup.string().notRequired().oneOf(["createdAt", "subdomain"])
}));
var DaoBalancesQuerySchema = /*#__PURE__*/sdkClientCommon.PaginationSchema.concat( /*#__PURE__*/yup.object({
  sortBy: /*#__PURE__*/yup.string().notRequired().oneOf(["lastUpdated"]),
  daoAddressOrEns: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.notRequired()
}));
var PluginQuerySchema = /*#__PURE__*/sdkClientCommon.PaginationSchema.concat( /*#__PURE__*/yup.object({
  sortBy: /*#__PURE__*/yup.string().notRequired().oneOf(["subdomain"]),
  subdomain: /*#__PURE__*/sdkClientCommon.SubdomainSchema.notRequired()
}));
var PermissionBaseSchema = /*#__PURE__*/yup.object({
  who: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  where: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  permission: /*#__PURE__*/yup.string().required()
});
var PermissionWithConditionSchema = /*#__PURE__*/PermissionBaseSchema.concat( /*#__PURE__*/yup.object({
  condition: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required()
}));
var WithdrawEthSchema = /*#__PURE__*/yup.object({
  type: /*#__PURE__*/yup.string().required().oneOf(["native"]),
  recipientAddressOrEns: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  amount: /*#__PURE__*/sdkClientCommon.BigintSchema.required()
});
var WithdrawErc20Schema = /*#__PURE__*/yup.object({
  type: /*#__PURE__*/yup.string().required().oneOf(["erc20"]),
  recipientAddressOrEns: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  tokenAddress: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  amount: /*#__PURE__*/sdkClientCommon.BigintSchema.required()
});
var WithdrawErc721Schema = /*#__PURE__*/yup.object({
  type: /*#__PURE__*/yup.string().required().oneOf(["erc721"]),
  daoAddressOrEns: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  recipientAddressOrEns: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  tokenAddress: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
...
var WithdrawErc1155Schema = /*#__PURE__*/yup.object({
  type: yup.string().required().oneOf(["erc1155"]),
  daoAddressOrEns: sdkClientCommon.AddressOrEnsSchema.required(),
  recipientAddressOrEns: sdkClientCommon.AddressOrEnsSchema.required(),
  tokenAddress: sdkClientCommon.AddressOrEnsSchema.required(),
  tokenIds: yup.array(sdkClientCommon.BigintSchema).required().min(1),
  amounts: yup.array(sdkClientCommon.BigintSchema).required().min(1)
}).test("isSameLength", new sdkClientCommon.SizeMismatchError("tokenIds", "amounts").message, function (value) {
...
var RegisterStandardCallbackSchema = /*#__PURE__*/yup.object({
  interfaceId: /*#__PURE__*/yup.string().required(),
  callbackSelector: /*#__PURE__*/yup.string().required(),
  magicNumber: /*#__PURE__*/yup.string().required()
});
var UpgradeToAndCallSchema = /*#__PURE__*/yup.object({
  implementationAddress: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.required(),
  data: /*#__PURE__*/sdkClientCommon.Uint8ArraySchema.required()
});
var InitializeFromSchema = /*#__PURE__*/yup.object({
  previousVersion: /*#__PURE__*/yup.array().of(yup.number()).length(3).required(),
  initData: /*#__PURE__*/sdkClientCommon.Uint8ArraySchema.notRequired()
});
var DaoUpdateSchema = /*#__PURE__*/yup.object({
  previousVersion: /*#__PURE__*/yup.array().of(yup.number()).length(3).required(),
  initData: /*#__PURE__*/sdkClientCommon.Uint8ArraySchema.notRequired(),
  daoFactoryAddress: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.notRequired()
});
var PluginPreparationQuerySchema = /*#__PURE__*/sdkClientCommon.PaginationSchema.concat( /*#__PURE__*/yup.object({
  sortBy: /*#__PURE__*/yup.string().notRequired().oneOf([exports.PluginPreparationSortBy.ID]),
  type: /*#__PURE__*/yup.string().notRequired().oneOf([exports.PluginPreparationType.INSTALLATION, exports.PluginPreparationType.UPDATE]),
  daoAddressOrEns: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.notRequired(),
  pluginAddress: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.notRequired(),
  pluginRepoAddress: /*#__PURE__*/sdkClientCommon.AddressOrEnsSchema.notRequired()
}));
...
function toNativeBalance(balance) {
  return {
    id: balance.id,
    type: sdkClientCommon.TokenType.NATIVE,
...
function toErc20Balance(balance) {
  return {
    id: balance.id,
    type: sdkClientCommon.TokenType.ERC20,
...
function toErc721Balance(balance) {
  return {
    id: balance.id,
    type: sdkClientCommon.TokenType.ERC721,
    address: balance.token.id,
    name: balance.token.name,
    symbol: balance.token.symbol,
    updateDate: new Date(parseInt(balance.lastUpdated) * 1000),
...
function toErc1155Balance(balance) {
  return {
    id: balance.id,
    type: sdkClientCommon.TokenType.ERC1155,
    address: balance.token.id,
...
function toAssetBalance(balance) {
  switch (balance.__typename) {
    ...
    default:
      throw new sdkClientCommon.InvalidParameter("Token type not supported");
  }
}
function toErc20Transfer(transfer) {
  ...
  if (transfer.type === SubgraphTransferType.DEPOSIT) {
    return {
      ...
      tokenType: sdkClientCommon.TokenType.ERC20,
      token: {
...
function toErc721Transfer(transfer) {
  ...
  if (transfer.type === SubgraphTransferType.DEPOSIT) {
    return {
      type: exports.TransferType.DEPOSIT,
      tokenType: sdkClientCommon.TokenType.ERC721,
      token: {
        address: transfer.token.id,
        name: transfer.token.name,
        symbol: transfer.token.symbol
...
function toErc1155Transfer(transfer) {
  ...
  if (transfer.type === SubgraphTransferType.DEPOSIT) {
    return {
      type: exports.TransferType.DEPOSIT,
      tokenType: sdkClientCommon.TokenType.ERC1155,
      amount: BigInt(transfer.amount),
...
function toNativeTransfer(transfer) {
  ...
  if (transfer.type === SubgraphTransferType.DEPOSIT) {
    return {
      type: exports.TransferType.DEPOSIT,
      tokenType: sdkClientCommon.TokenType.NATIVE,
      amount: BigInt(transfer.amount),
      creationDate: creationDate,
      transactionId: transfer.txHash,
      from: transfer.from,
...
function applyUpdateParamsFromContract(result) {
  ...
  return {
    ...
    pluginAddress: params.plugin,
    pluginRepo: params.pluginSetupRef.pluginSetupRepo,
    initData: sdkClientCommon.hexToBytes(params.initData)
  };
}
...
function permissionParamsFromContract(result) {
  ...
  return {
    ...
    permission: ((_Object$keys$find = Object.keys(sdkClientCommon.PermissionIds).find(function (k) {
      return sdkClientCommon.PermissionIds[k] === result[2];
...
function withdrawParamsFromContract(to, _value, result, tokenStandard, isBatch) {
  switch (tokenStandard) {
    case sdkClientCommon.TokenType.ERC20:
      return {
        type: sdkClientCommon.TokenType.ERC20,
        tokenAddress: to,
    ...
    case sdkClientCommon.TokenType.ERC721:
      return {
        type: sdkClientCommon.TokenType.ERC721,
        tokenAddress: to,
    ...
    case sdkClientCommon.TokenType.ERC1155:
  ...
  throw new sdkClientCommon.NotImplementedError("Token standard not supported");
}
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          _context.next = 5;
          return daoInstance.estimateGas.deposit(constants.AddressZero, params.amount, "");
        case 5:
  ...
  _estimateErc721Deposit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(signer, params) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          erc721Contract = new contracts.Contract(params.tokenAddress, ERC721_json.abi, signer);
  ...
  _estimateErc1155Deposit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(signer, params) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 2:
          erc1155Contract = new contracts.Contract(params.tokenAddress, ERC1155_json.abi, signer);
...
function decodeGrantAction(data) {
  ...
  var hexBytes = sdkClientCommon.bytesToHex(data);
...
function findInterface(data, functionSignatures) {
  try {
    var func = sdkClientCommon.getFunctionFragment(data, functionSignatures);
    return {
      id: func.format("minimal"),
      functionName: func.name,
      hash: sdkClientCommon.bytesToHex(data).substring(0, 10)
    };
  } catch (_unused) {
    return null;
  }
...
function toDaoActions(actions) {
  return actions.map(function (action) {
    return {
      ...
      data: sdkClientCommon.hexToBytes(action.data)
    };
  });
}
function hashPermissions(permissions) {
  return keccak256.keccak256(abi.defaultAbiCoder.encode(["tuple(uint8,address,address,address,bytes32)[]"], [permissions]));
}
function getPreparedSetupId(params, preparationType) {
  return keccak256.keccak256(abi.defaultAbiCoder.encode(["tuple(uint8, uint16)", "address", "bytes32", "bytes32", "bytes32", "uint8"], [[params.versionTag.release, params.versionTag.build], params.pluginRepo, hashPermissions(params.permissions), params.helpersHash, keccak256.keccak256(new Uint8Array()),
...
function decodeUpgradeToAndCallAction(data) {
  ...
  return {
    ...
    data: sdkClientCommon.hexToBytes(result[1])
  };
}
...
function decodeInitializeFromAction(data) {
  ...
  return {
    ...
    initData: sdkClientCommon.hexToBytes(result[1])
  };
}
function toPluginPreparationListItem(pluginPreparation) {
  return {
    ...
    data: sdkClientCommon.hexToBytes(pluginPreparation.data)
  };
}
function toPluginPermissionOperationType(operation) {
  switch (operation) {
    case SubgraphPluginPermissionOperation.GRANT:
      return sdkClientCommon.PermissionOperationType.GRANT;
    case SubgraphPluginPermissionOperation.REVOKE:
      return sdkClientCommon.PermissionOperationType.REVOKE;
    case SubgraphPluginPermissionOperation.GRANT_WITH_CONDITION:
      return sdkClientCommon.PermissionOperationType.GRANT_WITH_CONDITION;
    default:
      throw new sdkClientCommon.InvalidPermissionOperationType();
  }
}
      ...
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 4:
          ...
          if (pluginInstallations.length === 0) {
            causes.push(exports.PluginUpdateProposalInValidityCause.PLUGIN_NOT_INSTALLED);
          }
          // Value must be 0
          if (action.value.toString() !== "0") {
            causes.push(exports.PluginUpdateProposalInValidityCause.NON_ZERO_GRANT_UPGRADE_PLUGIN_PERMISSION_CALL_VALUE);
          }
          // The action should be sent to the DAO
          if (action.to !== daoAddress) {
            causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_GRANT_UPGRADE_PLUGIN_PERMISSION_TO_ADDRESS);
          }
          // The permission should be granted to the PSP
          if (decodedPermission.who !== pspAddress) {
            causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_GRANT_UPGRADE_PLUGIN_PERMISSION_WHO_ADDRESS);
          }
          // The permission should be `UPGRADE_PLUGIN_PERMISSION`
          if (decodedPermission.permission !== sdkClientCommon.Permissions.UPGRADE_PLUGIN_PERMISSION) {
            causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_GRANT_UPGRADE_PLUGIN_PERMISSION_PERMISSION_NAME);
          }
          // The permissionId should be `UPGRADE_PLUGIN_PERMISSION_ID`
          if (decodedPermission.permissionId !== sdkClientCommon.PermissionIds.UPGRADE_PLUGIN_PERMISSION_ID) {
            causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_GRANT_UPGRADE_PLUGIN_PERMISSION_PERMISSION_ID);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 4:
          ...
          // The action should be sent to the DAO
          if (action.to !== daoAddress) {
            causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_REVOKE_UPGRADE_PLUGIN_PERMISSION_TO_ADDRESS);
          }
          if (action.value.toString() !== "0") {
            causes.push(exports.PluginUpdateProposalInValidityCause.NON_ZERO_REVOKE_UPGRADE_PLUGIN_PERMISSION_CALL_VALUE);
          }
          if (decodedPermission.who !== pspAddress) {
            causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_REVOKE_UPGRADE_PLUGIN_PERMISSION_WHO_ADDRESS);
          }
          if (decodedPermission.permission !== sdkClientCommon.Permissions.UPGRADE_PLUGIN_PERMISSION) {
            causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_REVOKE_UPGRADE_PLUGIN_PERMISSION_PERMISSION_NAME);
          }
          if (decodedPermission.permissionId !== sdkClientCommon.PermissionIds.UPGRADE_PLUGIN_PERMISSION_ID) {
            causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_REVOKE_UPGRADE_PLUGIN_PERMISSION_PERMISSION_ID);
          }
...
function validateGrantRootPermissionAction(action, daoAddress, pspAddress) {
  ...
  if (action.value.toString() !== "0") {
    causes.push(exports.PluginUpdateProposalInValidityCause.NON_ZERO_GRANT_ROOT_PERMISSION_CALL_VALUE);
  }
  // The action should be sent to the DAO
  // both come from subgraph so they are already lowercase
  if (action.to !== daoAddress) {
    causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_GRANT_ROOT_PERMISSION_TO_ADDRESS);
  }
  ...
  if (decodedPermission.where.toLowerCase() !== daoAddress) {
    causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_GRANT_ROOT_PERMISSION_WHERE_ADDRESS);
  }
  if (decodedPermission.who !== pspAddress) {
    causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_GRANT_ROOT_PERMISSION_WHO_ADDRESS);
  }
  if (decodedPermission.permission !== sdkClientCommon.Permissions.ROOT_PERMISSION) {
    causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_GRANT_ROOT_PERMISSION_PERMISSION_NAME);
  }
  if (decodedPermission.permissionId !== sdkClientCommon.PermissionIds.ROOT_PERMISSION_ID) {
    causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_GRANT_ROOT_PERMISSION_PERMISSION_ID);
  }
  return causes;
}
function validateRevokeRootPermissionAction(action, daoAddress, pspAddress) {
  ...
  if (action.value.toString() !== "0") {
    causes.push(exports.PluginUpdateProposalInValidityCause.NON_ZERO_REVOKE_ROOT_PERMISSION_CALL_VALUE);
  }
  // The action should be sent to the DAO
  if (action.to !== daoAddress) {
    causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_REVOKE_ROOT_PERMISSION_TO_ADDRESS);
  }
  if (decodedPermission.where !== daoAddress) {
    causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_REVOKE_ROOT_PERMISSION_WHERE_ADDRESS);
  }
  if (decodedPermission.who !== pspAddress) {
    causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_REVOKE_ROOT_PERMISSION_WHO_ADDRESS);
  }
  if (decodedPermission.permission !== sdkClientCommon.Permissions.ROOT_PERMISSION) {
    causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_REVOKE_ROOT_PERMISSION_PERMISSION_NAME);
  }
  if (decodedPermission.permissionId !== sdkClientCommon.PermissionIds.ROOT_PERMISSION_ID) {
    causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_REVOKE_ROOT_PERMISSION_PERMISSION_ID);
  }
  return causes;
}
/**
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          causes = [];
          if (action.value.toString() !== "0") {
            causes.push(exports.PluginUpdateProposalInValidityCause.NON_ZERO_APPLY_UPDATE_CALL_VALUE);
          }
        ...
        case 11:
          ...
          if (((_plugin$appliedVersio = plugin.appliedVersion) == null ? void 0 : _plugin$appliedVersio.release.release) !== decodedParams.versionTag.release) {
            causes.push(exports.PluginUpdateProposalInValidityCause.UPDATE_TO_INCOMPATIBLE_RELEASE);
          }
          ...
          if (!((_plugin$appliedVersio2 = plugin.appliedVersion) != null && _plugin$appliedVersio2.build) || ((_plugin$appliedVersio3 = plugin.appliedVersion) == null ? void 0 : _plugin$appliedVersio3.build) >= decodedParams.versionTag.build) {
            causes.push(exports.PluginUpdateProposalInValidityCause.UPDATE_TO_OLDER_OR_SAME_BUILD);
          }
          _context8.next = 15;
          return graphql.request({
            query: QueryPlugin,
        ...
        case 15:
          ...
          causes.push(exports.PluginUpdateProposalInValidityCause.MISSING_PLUGIN_REPO);
          return _context8.abrupt("return", causes);
        case 20:
          // check if is one of the aragon plugin repos
          if (!SupportedPluginRepoArray.includes(pluginRepo.subdomain)) {
            causes.push(exports.PluginUpdateProposalInValidityCause.NOT_ARAGON_PLUGIN_REPO);
          }
        ...
        case 24:
          ...
          causes.push(exports.PluginUpdateProposalInValidityCause.MISSING_PLUGIN_PREPARATION);
          return _context8.abrupt("return", causes);
        case 29:
          ...
          causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_PLUGIN_REPO_METADATA);
          return _context8.abrupt("return", causes);
        case 34:
          metadataUri = build.metadata; // fetch the metadata
          metadataCid = new sdkClientCommon.MultiUri(metadataUri).ipfsCid;
          _context8.next = 38;
        ...
        case 47:
          ...
          abi.defaultAbiCoder.decode(sdkClientCommon.getNamedTypesFromMetadata(updateAbi), decodedParams.initData);
          _context8.next = 53;
          break;
        case 50:
          _context8.prev = 50;
          ...
          causes.push(exports.PluginUpdateProposalInValidityCause.INVALID_DATA);
        case 53:
          _context8.next = 56;
          break;
        case 55:
...
function classifyProposalActions(actions) {
  ...
  for (var _iterator2 = _createForOfIteratorHelperLoose(actions), _step2; !(_step2 = _iterator2()).done;) {
    ...
    try {
      ...
      var func = sdkClientCommon.getFunctionFragment(action.data, UPDATE_PLUGIN_SIGNATURES);
      switch (func.name) {
        case "upgradeTo":
        ...
        case "grant":
          ...
          switch (decodedPermission.permission) {
            case sdkClientCommon.Permissions.UPGRADE_PLUGIN_PERMISSION:
              classifiedActions.push(ProposalActionTypes.GRANT_PLUGIN_UPGRADE_PERMISSION);
              break;
            case sdkClientCommon.Permissions.ROOT_PERMISSION:
...
function validateUpdateDaoProposalActions(actions, daoAddress, expectedImplementationAddress, currentDaoVersion) {
  ...
  if (!startsWithDaoUpdateAction(classifiedActions)) {
    ...
    return {
      isValid: false,
      proposalSettingsErrorCauses: [exports.ProposalSettingsErrorCause.INVALID_ACTIONS],
      actionErrorCauses: []
    };
  }
  ...
  if (upgradeAction.to !== daoAddress) {
    actionErrorCauses.push(exports.DaoUpdateProposalInvalidityCause.INVALID_TO_ADDRESS);
  }
  // if the value is different from 0
  // add the cause to the causes array
  if (upgradeAction.value.toString() !== "0") {
    actionErrorCauses.push(exports.DaoUpdateProposalInvalidityCause.NON_ZERO_CALL_VALUE);
  }
  switch (upgradeActionType) {
    case ProposalActionTypes.UPGRADE_TO:
      ...
      if (expectedImplementationAddress !== decodedImplementationAddress) {
        actionErrorCauses.push(exports.DaoUpdateProposalInvalidityCause.INVALID_UPGRADE_TO_IMPLEMENTATION_ADDRESS);
      }
      break;
    case ProposalActionTypes.UPGRADE_TO_AND_CALL:
      ...
      if (expectedImplementationAddress !== upgradeToAndCallDecodedParams.implementationAddress) {
        actionErrorCauses.push(exports.DaoUpdateProposalInvalidityCause.INVALID_UPGRADE_TO_AND_CALL_IMPLEMENTATION_ADDRESS);
      }
      ...
      if (JSON.stringify(initializeFromDecodedParams.previousVersion) !== JSON.stringify(currentDaoVersion)) {
        actionErrorCauses.push(exports.DaoUpdateProposalInvalidityCause.INVALID_UPGRADE_TO_AND_CALL_VERSION);
      }
      ...
      if (initializeFromDecodedParams.initData.length !== 0) {
        actionErrorCauses.push(exports.DaoUpdateProposalInvalidityCause.INVALID_UPGRADE_TO_AND_CALL_DATA);
      }
      break;
    default:
      proposalSettingsErrorCauses.push(exports.ProposalSettingsErrorCause.INVALID_ACTIONS);
      break;
  }
    ...
    return _wrapAsyncGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _awaitAsyncGenerator(sdkClientCommon.PrepareInstallationSchema.strict().validate(params));
          case 2:
            return _context.delegateYield(_asyncGeneratorDelegate(_asyncIterator(sdkClientCommon.prepareGenericInstallation(_this.web3, _extends({}, params, {
              pluginSetupProcessorAddress: _this.web3.getAddress(osxCommonsConfigs.FrameworkContractsNames.PLUGIN_SETUP_PROCESSOR)
            })))), "t0", 3);
          case 3:
          case "end":
            return _context.stop();
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            daoFactoryInstance = osxEthers.DAOFactory__factory.connect(_this2.web3.getAddress(osxCommonsConfigs.FrameworkContractsNames.DAO_FACTORY), signer);
          ...
          case 31:
            ...
            found = pluginSetupProcessorResponse[1].permissions.find(function (permission) {
              return permission.permissionId === sdkClientCommon.PermissionIds.EXECUTE_PERMISSION_ID;
            });
            if (!found) {
              _context2.next = 36;
              break;
          ...
          case 39:
            ...
            throw new sdkClientCommon.MissingExecPermissionError();
          case 41:
            _context2.next = 43;
            return _awaitAsyncGenerator(daoFactoryInstance.connect(signer).createDao({
              ...
              trustedForwarder: (_params$trustedForwar = params.trustedForwarder) != null ? _params$trustedForwar : constants.AddressZero
            }, pluginInstallationData));
          case 43:
            tx = _context2.sent;
            _context2.next = 46;
          ...
          case 48:
            ...
            throw new sdkClientCommon.DaoCreationError();
          case 53:
            // Plugin logs
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 11:
            ...
            throw new sdkClientCommon.IpfsPinError(_context3.t0);
          case 14:
          case "end":
            return _context3.stop();
        }
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = _context4.t0 === sdkClientCommon.TokenType.NATIVE ? 3 : _context4.t0 === sdkClientCommon.TokenType.ERC20 ? 5 : _context4.t0 === sdkClientCommon.TokenType.ERC721 ? 7 : _context4.t0 === sdkClientCommon.TokenType.ERC1155 ? 9 : 11;
            break;
          case 3:
          ...
          case 10:
            return _context4.abrupt("break", 12);
          case 11:
            throw new sdkClientCommon.NotImplementedError("Token type not valid, use transfer function instead");
          case 12:
          case "end":
            return _context4.stop();
        }
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            daoInstance = osxEthers.DAO__factory.connect(daoAddressOrEns, signer);
            _context5.next = 8;
            return _awaitAsyncGenerator(daoInstance.deposit(constants.AddressZero, amount, "", override));
          case 8:
            tx = _context5.sent;
            _context5.next = 11;
            return {
          ...
          case 13:
            cr = _context5.sent;
            log = sdkClientCommon.findLog(cr, daoInstance["interface"], "Deposited");
            if (log) {
              _context5.next = 17;
              break;
            }
            throw new sdkClientCommon.FailedDepositError();
          case 17:
            ...
            throw new sdkClientCommon.AmountMismatchError(amount, parsedLog.args["amount"].toBigInt());
          case 21:
            _context5.next = 23;
            return {
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            tokenContract = new contracts.Contract(tokenAddress, ERC20_json.abi, signer);
    ...
    return _wrapAsyncGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          ...
          case 17:
            cr = _context7.sent;
            log = sdkClientCommon.findLog(cr, erc721Contract["interface"], "Transfer");
            if (log) {
              _context7.next = 21;
              break;
            }
    ...
    return _wrapAsyncGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          ...
          case 39:
            cr = _context8.sent;
            log = sdkClientCommon.findLog(cr, erc1155Contract["interface"], logName);
            if (log) {
              _context8.next = 43;
              break;
            }
      ...
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          case 0:
            ...
            tokenInstance = new contracts.Contract(params.tokenAddress, ERC20_json.abi, signer);
            _context9.next = 4;
          ...
          case 9:
            cr = _context9.sent;
            log = sdkClientCommon.findLog(cr, tokenInstance["interface"], "Approval");
            if (log) {
              _context9.next = 13;
              break;
            }
            throw new sdkClientCommon.UpdateAllowanceError();
          case 13:
            value = log.data;
    ...
    return _wrapAsyncGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          case 0:
            _context10.next = 2;
            return _awaitAsyncGenerator(sdkClientCommon.PrepareUninstallationSchema.strict().validate(params));
          case 2:
          ...
          case 5:
            ...
            throw new sdkClientCommon.InstallationNotFoundError();
          case 11:
            ...
            pspContract = osxEthers.PluginSetupProcessor__factory.connect(_this9.web3.getAddress(osxCommonsConfigs.FrameworkContractsNames.PLUGIN_SETUP_PROCESSOR), signer);
            _context10.next = 16;
          ...
          case 16:
            ...
            _context10.next = 19;
            return {
              key: sdkClientCommon.PrepareUninstallationSteps.PREPARING,
              txHash: tx.hash
            };
          case 19:
            _context10.next = 21;
          ...
          case 21:
            cr = _context10.sent;
            log = sdkClientCommon.findLog(cr, pspContract["interface"], "UninstallationPrepared");
            if (log) {
              _context10.next = 25;
              break;
            }
            throw new sdkClientCommon.PluginUninstallationPreparationError();
          case 25:
          ...
          case 29:
            _context10.next = 31;
            return {
              key: sdkClientCommon.PrepareUninstallationSteps.DONE,
    ...
    return _wrapAsyncGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
      return _regeneratorRuntime().wrap(function _callee11$(_context11) {
        while (1) switch (_context11.prev = _context11.next) {
          case 0:
            return _context11.delegateYield(_asyncGeneratorDelegate(_asyncIterator(sdkClientCommon.prepareGenericUpdate(_this10.web3, _this10.graphql, _extends({}, params, {
              pluginSetupProcessorAddress: _this10.web3.getAddress(osxCommonsConfigs.FrameworkContractsNames.PLUGIN_SETUP_PROCESSOR)
            })))), "t0", 1);
          case 1:
          case "end":
      ...
      return _regeneratorRuntime().wrap(function _callee12$(_context12) {
        while (1) switch (_context12.prev = _context12.next) {
          ...
          case 2:
            ...
            daoInstance = osxEthers.DAO__factory.connect(params.daoAddressOrEns, provider);
            return _context12.abrupt("return", daoInstance.hasPermission(params.where, params.who, hash.id(params.permission), params.data || new Uint8Array([])));
          case 5:
          case "end":
    ...
    var _getDao = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(daoAddressOrEns) {
      ...
      return _regeneratorRuntime().wrap(function _callee13$(_context13) {
        while (1) switch (_context13.prev = _context13.next) {
          case 0:
            _context13.next = 2;
            return sdkClientCommon.AddressOrEnsSchema.strict().validate(daoAddressOrEns);
          case 2:
            address$1 = daoAddressOrEns.toLowerCase();
          ...
          case 6:
            ...
            throw new sdkClientCommon.NoProviderError();
          case 9:
            _context13.prev = 9;
            _context13.next = 12;
          ...
          case 12:
            ...
            throw new sdkClientCommon.InvalidAddressOrEnsError();
          case 15:
          ...
          case 18:
            ...
            throw new sdkClientCommon.InvalidAddressOrEnsError(_context13.t0);
          case 21:
            query = QueryDao;
            params = {
              address: address$1
          ...
          case 34:
            _context13.prev = 34;
            metadataCid = sdkClientCommon.resolveIpfsCid(dao.metadata);
            _context13.next = 38;
          ...
          case 43:
            ...
            if (!(_context13.t1 instanceof sdkClientCommon.InvalidCidError)) {
              _context13.next = 47;
              break;
            }
              ...
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(dao) {
                ...
                return _regeneratorRuntime().wrap(function _callee14$(_context14) {
                  while (1) switch (_context14.prev = _context14.next) {
                    ...
                    case 2:
                      _context14.prev = 2;
                      metadataCid = sdkClientCommon.resolveIpfsCid(dao.metadata); // Avoid blocking Promise.all if this individual fetch takes too long
                      _context14.next = 6;
                      return sdkClientCommon.promiseWithTimeout(_this11.ipfs.fetchString(metadataCid), sdkClientCommon.MULTI_FETCH_TIMEOUT);
                    case 6:
                    ...
                    case 11:
                      ...
                      if (!(_context14.t0 instanceof sdkClientCommon.InvalidCidError)) {
                        _context14.next = 15;
                        break;
                      }
      ...
      return _regeneratorRuntime().wrap(function _callee17$(_context17) {
        while (1) switch (_context17.prev = _context17.next) {
          ...
          case 19:
            ...
            throw new sdkClientCommon.InvalidAddressOrEnsError(_context17.t0);
          case 22:
            where = {
              dao: address$1.toLowerCase()
            };
    ...
    var _getMetadata = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee18(ipfsUri) {
      ...
      return _regeneratorRuntime().wrap(function _callee18$(_context18) {
        while (1) switch (_context18.prev = _context18.next) {
          case 0:
            metadataCid = sdkClientCommon.resolveIpfsCid(ipfsUri);
            _context18.next = 3;
            return this.ipfs.fetchString(metadataCid);
          case 3:
      ...
      return _regeneratorRuntime().wrap(function _callee19$(_context19) {
        while (1) switch (_context19.prev = _context19.next) {
          ...
          case 9:
            ...
            if (_context19.t0 instanceof sdkClientCommon.InvalidCidError) {
              releaseMetadata = UNSUPPORTED_RELEASE_METADATA_LINK;
            } else if (_context19.t0 instanceof sdkClientCommon.EmptyMultiUriError) {
          ...
          case 20:
            ...
            if (_context19.t1 instanceof sdkClientCommon.InvalidCidError) {
              buildMetadata = UNSUPPORTED_BUILD_METADATA_LINK;
            } else if (_context19.t1 instanceof sdkClientCommon.EmptyMultiUriError) {
      ...
      return _regeneratorRuntime().wrap(function _callee21$(_context21) {
        while (1) switch (_context21.prev = _context21.next) {
          case 0:
            ...
            _context21.next = 3;
            return sdkClientCommon.AddressOrEnsSchema.strict().validate(pluginAddress);
          case 3:
            name = "plugin version";
            query = QueryPlugin;
            _context21.next = 7;
    ...
    var _getProtocolVersion = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee22(contractAddress) {
      ...
      return _regeneratorRuntime().wrap(function _callee22$(_context22) {
        while (1) switch (_context22.prev = _context22.next) {
          case 0:
            _context22.next = 2;
            return sdkClientCommon.AddressOrEnsSchema.strict().validate(contractAddress);
          case 2:
            provider = this.web3.getProvider();
            protocolInstance = osxEthers.IProtocolVersion__factory.connect(contractAddress, provider);
            _context22.prev = 4;
            _context22.next = 7;
        ...
        while (1) switch (_context23.prev = _context23.next) {
          case 0:
            ...
            return this.graphql.request({
              query: query,
              params: {
                id: sdkClientCommon.getExtendedProposalId(proposalId.toLowerCase())
              },
              name: name
            });
          case 4:
        ...
        while (1) switch (_context25.prev = _context25.next) {
          ...
          case 4:
            ...
            return _context25.abrupt("return", {
              isValid: false,
              actionErrorCauses: [],
              proposalSettingsErrorCauses: [exports.ProposalSettingsErrorCause.PROPOSAL_NOT_FOUND]
            });
          case 8:
            ...
            return _context25.abrupt("return", {
              isValid: false,
              actionErrorCauses: [],
              proposalSettingsErrorCauses: [exports.ProposalSettingsErrorCause.NON_ZERO_ALLOW_FAILURE_MAP_VALUE]
            });
          case 10:
            ...
            // validate actions
            return _context25.abrupt("return", validateUpdatePluginProposalActions(daoActions, iproposal.dao.id, this.web3.getAddress(osxCommonsConfigs.FrameworkContractsNames.PLUGIN_SETUP_PROCESSOR), this.graphql, this.ipfs));
          case 14:
          case "end":
      ...
      return _regeneratorRuntime().wrap(function _callee26$(_context26) {
        while (1) switch (_context26.prev = _context26.next) {
          ...
          case 10:
            ...
            daoFactoryAddress = this.web3.getAddress(osxCommonsConfigs.FrameworkContractsNames.DAO_FACTORY);
            if (version) {
              // if version is specified get the dao factory address from the live contracts
              daoFactoryAddress = osxCommonsConfigs.contracts[this.web3.getNetworkName()][version].DAOFactory.address;
            }
    ...
    var _getDaoImplementation = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee27(daoFactoryAddress) {
      ...
      return _regeneratorRuntime().wrap(function _callee27$(_context27) {
        while (1) switch (_context27.prev = _context27.next) {
          case 0:
            daoFactoryImplementation = osxEthers.DAOFactory__factory.connect(daoFactoryAddress, this.web3.getProvider());
...
var ClientEncoding = /*#__PURE__*/function (_ClientCore) {
  ...
  _proto.applyInstallationAction = function applyInstallationAction(daoAddress, params) {
    sdkClientCommon.AddressOrEnsSchema.strict().validateSync(daoAddress);
    sdkClientCommon.ApplyInstallationSchema.strict().validateSync(params);
    var pspInterface = osxEthers.PluginSetupProcessor__factory.createInterface();
    ...
    var pspAddress = this.web3.getAddress(osxCommonsConfigs.FrameworkContractsNames.PLUGIN_SETUP_PROCESSOR);
    // Grant ROOT_PERMISION in the DAO to the PSP
    var grantAction = this.grantAction(daoAddress, {
      where: daoAddress,
      who: pspAddress,
      permission: sdkClientCommon.Permissions.ROOT_PERMISSION
    });
    ...
    return [grantAction, {
      to: pspAddress,
      value: BigInt(0),
      data: sdkClientCommon.hexToBytes(hexBytes)
    }, revokeAction];
  };
  _proto.applyUninstallationAction = function applyUninstallationAction(daoAddress, params) {
    sdkClientCommon.AddressOrEnsSchema.strict().validateSync(daoAddress);
    sdkClientCommon.ApplyUninstallationSchema.strict().validateSync(params);
    var pspInterface = osxEthers.PluginSetupProcessor__factory.createInterface();
  ...
  _proto.applyUpdateAndPermissionsActionBlock = function applyUpdateAndPermissionsActionBlock(daoAddress, params) {
    ...
    var grantUpgradeAction = this.grantAction(daoAddress, {
      ...
      who: pspAddress,
      permission: sdkClientCommon.Permissions.UPGRADE_PLUGIN_PERMISSION
    });
  ...
  _proto.grantAction = function grantAction(daoAddress, params) {
    ...
    if (!address.isAddress(where) || !address.isAddress(who) || !address.isAddress(daoAddress)) {
      throw new sdkClientCommon.InvalidAddressError();
    }
    var daoInterface = osxEthers.DAO__factory.createInterface();
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            _context.next = _context.t0 === sdkClientCommon.TokenType.NATIVE ? 11 : _context.t0 === sdkClientCommon.TokenType.ERC20 ? 14 : _context.t0 === sdkClientCommon.TokenType.ERC721 ? 19 : _context.t0 === sdkClientCommon.TokenType.ERC1155 ? 24 : 29;
            break;
          case 11:
            _context.next = 13;
          ...
          case 16:
            iface = new contracts.Contract(params.tokenAddress, ERC20_json.abi)["interface"];
            data = iface.encodeFunctionData("transfer", [params.recipientAddressOrEns, params.amount]);
            return _context.abrupt("return", {
              to: params.tokenAddress,
              value: BigInt(0),
              data: sdkClientCommon.hexToBytes(data)
            });
          case 19:
            _context.next = 21;
            return WithdrawErc721Schema.strict().validate(params);
          case 21:
            iface = new contracts.Contract(params.tokenAddress, ERC721_json.abi)["interface"];
          ...
          case 26:
            iface = new contracts.Contract(params.tokenAddress, ERC1155_json.abi)["interface"];
            if (params.tokenIds.length === 1) {
          ...
          case 29:
            throw new sdkClientCommon.NotImplementedError("Token type not supported");
          case 30:
          case "end":
            return _context.stop();
        }
    ...
    var _updateDaoMetadataAction = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(daoAddressOrEns, metadataUri) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 2:
            _context2.next = 4;
            return sdkClientCommon.IpfsUriSchema.strict().validate(metadataUri);
          case 4:
            address$1 = daoAddressOrEns;
          ...
          case 8:
            ...
            throw new sdkClientCommon.InvalidEnsError();
          case 11:
            address$1 = resolvedAddress;
          case 12:
  ...
  _proto.setDaoUriAction = function setDaoUriAction(daoAddressOrEns, daoUri) {
    sdkClientCommon.AddressOrEnsSchema.strict().validateSync(daoAddressOrEns);
    yup.string().url().strict().validateSync(daoUri);
    var daoInterface = osxEthers.DAO__factory.createInterface();
  ...
  _proto.setSignatureValidatorAction = function setSignatureValidatorAction(daoAddressOrEns, signatureValidator) {
    sdkClientCommon.AddressOrEnsSchema.strict().validateSync(daoAddressOrEns);
    sdkClientCommon.AddressOrEnsSchema.strict().validateSync(signatureValidator);
    var daoInterface = osxEthers.DAO__factory.createInterface();
  ...
  _proto.upgradeToAction = function upgradeToAction(daoAddressOrEns, implementationAddress) {
    sdkClientCommon.AddressOrEnsSchema.strict().validateSync(daoAddressOrEns);
    sdkClientCommon.AddressOrEnsSchema.strict().validateSync(implementationAddress);
    var daoInterface = osxEthers.DAO__factory.createInterface();
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            daoFactory = osxEthers.DAOFactory__factory.connect(daoFactoryAddress != null ? daoFactoryAddress : this.web3.getAddress(osxCommonsConfigs.FrameworkContractsNames.DAO_FACTORY), this.web3.getProvider());
            _context3.next = 7;
    ...
    var _prepareInstallation = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(params) {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return sdkClientCommon.PrepareInstallationSchema.strict().validate(params);
          case 2:
            return _context.abrupt("return", sdkClientCommon.prepareGenericInstallationEstimation(this.web3, params));
          case 3:
          case "end":
            return _context.stop();
        }
    ...
    var _createDao = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 2:
            provider = this.web3.getProvider();
            daoInstance = osxEthers.DAOFactory__factory.connect(this.web3.getAddress(osxCommonsConfigs.FrameworkContractsNames.DAO_FACTORY), provider);
            pluginInstallationData = [];
            _iterator = _createForOfIteratorHelperLoose(params.plugins);
          case 6:
            if ((_step = _iterator()).done) {
            ...
            plugin = _step.value;
            repo = osxEthers.PluginRepo__factory.connect(plugin.id, provider);
            _context2.next = 11;
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = _context3.t0 === sdkClientCommon.TokenType.NATIVE ? 4 : _context3.t0 === sdkClientCommon.TokenType.ERC20 ? 10 : _context3.t0 === sdkClientCommon.TokenType.ERC721 ? 16 : _context3.t0 === sdkClientCommon.TokenType.ERC1155 ? 22 : 28;
            break;
          case 4:
            _context3.next = 6;
            return DepositEthSchema.strict().validate(params);
          ...
          case 26:
            ...
            return _context3.abrupt("break", 29);
          case 28:
            throw new sdkClientCommon.NotImplementedError("Token type not valid");
          case 29:
    ...
    var _setAllowance = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 16:
            contract = new contracts.Contract(params.tokenAddress, ERC20_json.abi, signer);
    ...
    var _prepareUpdate = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(params) {
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return sdkClientCommon.prepareGenericUpdateEstimation(this.web3, this.graphql, _extends({}, params, {
              pluginSetupProcessorAddress: this.web3.getAddress(osxCommonsConfigs.FrameworkContractsNames.PLUGIN_SETUP_PROCESSOR)
            }));
          case 2:
...
var ClientDecoding = /*#__PURE__*/function (_ClientCore) {
  ...
  _proto.applyInstallationAction = function applyInstallationAction(data) {
    sdkClientCommon.Uint8ArraySchema.strict().validateSync(data);
    var pspInterface = osxEthers.PluginSetupProcessor__factory.createInterface();
    var hexBytes = sdkClientCommon.bytesToHex(data);
  ...
  _proto.grantAction = function grantAction(data) {
    sdkClientCommon.Uint8ArraySchema.strict().validate(data);
  ...
  _proto.withdrawAction = function withdrawAction(to, value, data) {
    sdkClientCommon.AddressOrEnsSchema.strict().validateSync(to);
    sdkClientCommon.BigintSchema.strict().validateSync(value);
    sdkClientCommon.Uint8ArraySchema.strict().validateSync(data);
    // Native
    ...
    // ERC20 and other
    var abiObjects = [{
      tokenStandard: sdkClientCommon.TokenType.ERC20,
      abi: ERC20_json.abi,
      batch: false,
      "function": "transfer"
    }, {
      tokenStandard: sdkClientCommon.TokenType.ERC721,
      abi: ERC721_json.abi,
      batch: false,
      "function": "safeTransferFrom(address,address,uint256)"
    }, {
      tokenStandard: sdkClientCommon.TokenType.ERC1155,
      abi: ERC1155_json.abi,
      batch: true,
    ...
    throw new sdkClientCommon.InvalidActionError();
  }
  /**
  ...
  _proto.updateDaoMetadataRawAction = function updateDaoMetadataRawAction(data) {
    ...
    sdkClientCommon.resolveIpfsCid(metadataUri);
    return metadataUri;
  }
  /**
    ...
    var _updateDaoMetadataAction = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return sdkClientCommon.Uint8ArraySchema.strict().validate(data);
          case 2:
            daoInterface = osxEthers.DAO__factory.createInterface();
            hexBytes = sdkClientCommon.bytesToHex(data);
            ...
            ipfsCid = sdkClientCommon.resolveIpfsCid(metadataUri);
            _context.prev = 8;
            _context.next = 11;
          ...
          case 15:
            ...
            throw new sdkClientCommon.IpfsError(_context.t0);
          case 18:
          case "end":
            return _context.stop();
        }
...
exports.SubgraphVoteValues = void 0;
...
// STEPS
// PROPOSAL CREATION
exports.ProposalCreationSteps = void 0;
...
// PROPOSAL VOTING
exports.VoteProposalStep = void 0;
...
// PROPOSAL EXECUTION
exports.ExecuteProposalStep = void 0;
...
exports.MembersSortBy = void 0;
(function (MembersSortBy) {
  MembersSortBy["ADDRESS"] = "address";
})(exports.MembersSortBy || (exports.MembersSortBy = {}));

var multisigInterface = /*#__PURE__*/osxEthers.Multisig__factory.createInterface();
var majorityVotingInterface = /*#__PURE__*/osxEthers.MajorityVotingBase__factory.createInterface();
...
function votingModeToContracts(votingMode) {
  switch (votingMode) {
    ...
    case exports.VotingMode.VOTE_REPLACEMENT:
      return 2;
    default:
      throw new sdkClientCommon.InvalidVotingModeError();
  }
}
...
function isFailingProposal(actions) {
  ...
  var functionNames = actions.map(function (action) {
    try {
      var fragment = sdkClientCommon.getFunctionFragment(action.data, FAILING_PROPOSAL_AVAILABLE_FUNCTION_SIGNATURES);
...
function encodeUpdateVotingSettingsAction(params) {
  ...
  return sdkClientCommon.hexToBytes(hexBytes);
}
function pluginSettingsFromContract(result) {
  return {
    votingMode: votingModeFromContracts(result[0][0]),
    supportThreshold: sdkClientCommon.decodeRatio(result[0][1], 6),
    minParticipation: sdkClientCommon.decodeRatio(result[0][2], 6),
...
function votingSettingsToContract(params) {
  ...
  return [bignumber.BigNumber.from(votingModeToContracts(params.votingMode || exports.VotingMode.STANDARD)), bignumber.BigNumber.from(sdkClientCommon.encodeRatio(params.supportThreshold, 6)), bignumber.BigNumber.from(sdkClientCommon.encodeRatio(params.minParticipation, 6)), bignumber.BigNumber.from(params.minDuration), bignumber.BigNumber.from((_params$minProposerVo = params.minProposerVotingPower) != null ? _params$minProposerVo : 0)];
}
...
function toAddresslistVotingProposal(proposal, metadata) {
  ...
  return {
    id: sdkClientCommon.getCompactProposalId(proposal.id),
    dao: {
    ...
    settings: {
      supportThreshold: sdkClientCommon.decodeRatio(BigInt(proposal.supportThreshold), 6),
      minParticipation: sdkClientCommon.decodeRatio(BigInt(proposal.minVotingPower) * BigInt(1000000) / BigInt(proposal.totalVotingPower), 6),
...
function computeProposalStatus$2(proposal) {
  ...
  if (proposal.approvalReached && endDate <= now) {
    return sdkClientCommon.ProposalStatus.SUCCEEDED;
  }
  ...
  if (now < endDate) {
    return sdkClientCommon.ProposalStatus.ACTIVE;
  }
  // If none of the other conditions are met the status becomes DEFEATED
  return sdkClientCommon.ProposalStatus.DEFEATED;
}
function computeProposalStatusFilter$2(status) {
  var where = {};
  var now = Math.round(new Date().getTime() / 1000).toString();
  switch (status) {
    case sdkClientCommon.ProposalStatus.PENDING:
      where = {
        startDate_gte: now
      };
      break;
    case sdkClientCommon.ProposalStatus.ACTIVE:
      where = {
        startDate_lt: now,
        endDate_gte: now,
        executed: false
      ...
      break;
    case sdkClientCommon.ProposalStatus.EXECUTED:
      where = {
        executed: true
      };
      break;
    case sdkClientCommon.ProposalStatus.SUCCEEDED:
      where = {
        or: [{
      ...
      break;
    case sdkClientCommon.ProposalStatus.DEFEATED:
      where = {
...
var AddresslistVotingClientMethods = /*#__PURE__*/function (_ClientCore) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            throw new sdkClientCommon.SizeMismatchError("failSafeActions", "actions");
          case 4:
            allowFailureMap = sdkClientCommon.boolArrayToBitmap(params.failSafeActions);
          ...
          case 14:
            ...
            log = sdkClientCommon.findLog(receipt, addresslistContractInterface, "ProposalCreated");
            if (log) {
              _context.next = 19;
              break;
            }
            throw new sdkClientCommon.ProposalCreationError();
          case 19:
          ...
          case 23:
            ...
            return {
              ...
              proposalId: sdkClientCommon.encodeProposalId(params.pluginAddress, Number(proposalId))
            };
          case 25:
          case "end":
            return _context.stop();
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            throw new sdkClientCommon.IpfsPinError(_context2.t0);
          case 12:
          case "end":
            return _context2.stop();
        }
    ...
    return _wrapAsyncGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            signer = _this2.web3.getConnectedSigner();
            _decodeProposalId = sdkClientCommon.decodeProposalId(params.proposalId), pluginAddress = _decodeProposalId.pluginAddress, id = _decodeProposalId.id;
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _decodeProposalId2 = sdkClientCommon.decodeProposalId(proposalId), pluginAddress = _decodeProposalId2.pluginAddress, id = _decodeProposalId2.id;
            addresslistContract = osxEthers.AddresslistVoting__factory.connect(pluginAddress, signer);
            _context4.next = 5;
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            aragonNetwork = osxCommonsConfigs.getNetworkByAlias(network.name);
            if (aragonNetwork) {
              _context5.next = 6;
              break;
            }
            throw new sdkClientCommon.UnsupportedNetworkError(network.name);
          case 6:
            return _context5.delegateYield(_asyncGeneratorDelegate(_asyncIterator(sdkClientCommon.prepareGenericInstallation(_this4.web3, {
              daoAddressOrEns: params.daoAddressOrEns,
              pluginRepo: _this4.web3.getAddress(osxCommonsConfigs.NonFrameworkContractsNames.ADDRESSLIST_VOTING_REPO_PROXY),
              ...
              pluginSetupProcessorAddress: _this4.web3.getAddress(osxCommonsConfigs.FrameworkContractsNames.PLUGIN_SETUP_PROCESSOR)
            }))), "t0", 7);
          case 7:
          case "end":
            return _context5.stop();
  ...
  _proto.prepareUpdate = function prepareUpdate(params) {
    ...
    return _wrapAsyncGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            return _context6.delegateYield(_asyncGeneratorDelegate(_asyncIterator(sdkClientCommon.prepareGenericUpdate(_this5.web3, _this5.graphql, _extends({}, params, {
              pluginRepo: _this5.web3.getAddress(osxCommonsConfigs.NonFrameworkContractsNames.ADDRESSLIST_VOTING_REPO_PROXY),
              updateAbi: UPDATE_ABI$2[params.newVersion.build] || params.updateAbi || [],
              pluginSetupProcessorAddress: _this5.web3.getAddress(osxCommonsConfigs.FrameworkContractsNames.PLUGIN_SETUP_PROCESSOR)
            })))), "t0", 1);
          case 1:
          case "end":
            return _context6.stop();
    ...
    var _canVote = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            provider = this.web3.getProvider();
            _decodeProposalId3 = sdkClientCommon.decodeProposalId(params.proposalId), pluginAddress = _decodeProposalId3.pluginAddress, id = _decodeProposalId3.id;
            addresslistContract = osxEthers.AddresslistVoting__factory.connect(pluginAddress, provider);
    ...
    var _canExecute = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(proposalId) {
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            provider = this.web3.getProvider();
            _decodeProposalId4 = sdkClientCommon.decodeProposalId(proposalId), pluginAddress = _decodeProposalId4.pluginAddress, id = _decodeProposalId4.id;
            addresslistContract = osxEthers.AddresslistVoting__factory.connect(pluginAddress, provider);
  ...
  function () {
    var _getProposal = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(proposalId) {
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          case 0:
            if (sdkClientCommon.isProposalId(proposalId)) {
              _context10.next = 2;
              break;
            }
            throw new sdkClientCommon.InvalidProposalIdError();
          case 2:
            extendedProposalId = sdkClientCommon.getExtendedProposalId(proposalId);
          ...
          case 14:
            ...
            return _context10.abrupt("return", toAddresslistVotingProposal(addresslistVotingProposal, sdkClientCommon.EMPTY_PROPOSAL_METADATA_LINK));
          case 16:
            _context10.prev = 16;
            metadataCid = sdkClientCommon.resolveIpfsCid(addresslistVotingProposal.metadata);
            _context10.next = 20;
            return this.ipfs.fetchString(metadataCid);
          case 20:
          ...
          case 25:
            ...
            if (!(_context10.t0 instanceof sdkClientCommon.InvalidCidError)) {
              _context10.next = 29;
              break;
            }
            return _context10.abrupt("return", toAddresslistVotingProposal(addresslistVotingProposal, sdkClientCommon.UNSUPPORTED_PROPOSAL_METADATA_LINK));
          case 29:
            return _context10.abrupt("return", toAddresslistVotingProposal(addresslistVotingProposal, sdkClientCommon.UNAVAILABLE_PROPOSAL_METADATA));
          case 30:
          case "end":
            return _context10.stop();
        }
  ...
  function () {
    var _getProposals = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(_ref2) {
      var _this6 = this;
      var daoAddressOrEns, _ref2$limit, limit, status, _ref2$skip, skip, _ref2$direction, direction, _ref2$sortBy, sortBy, where, address$1, provider, resolvedAddress, query, params, name, _yield$this$graphql$r3, addresslistVotingProposals;
      return _regeneratorRuntime().wrap(function _callee12$(_context12) {
        while (1) switch (_context12.prev = _context12.next) {
          case 0:
            daoAddressOrEns = _ref2.daoAddressOrEns, _ref2$limit = _ref2.limit, limit = _ref2$limit === void 0 ? 10 : _ref2$limit, status = _ref2.status, _ref2$skip = _ref2.skip, skip = _ref2$skip === void 0 ? 0 : _ref2$skip, _ref2$direction = _ref2.direction, direction = _ref2$direction === void 0 ? sdkClientCommon.SortDirection.ASC : _ref2$direction, _ref2$sortBy = _ref2.sortBy, sortBy = _ref2$sortBy === void 0 ? exports.ProposalSortBy.CREATED_AT : _ref2$sortBy;
            where = {};
            address$1 = daoAddressOrEns;
            if (!address$1) {
              _context12.next = 23;
                ...
                return _regeneratorRuntime().wrap(function _callee11$(_context11) {
                  while (1) switch (_context11.prev = _context11.next) {
                    case 0:
                      ...
                      return _context11.abrupt("return", toAddresslistVotingProposalListItem(proposal, sdkClientCommon.EMPTY_PROPOSAL_METADATA_LINK));
                    case 2:
                      _context11.prev = 2;
                      metadataCid = sdkClientCommon.resolveIpfsCid(proposal.metadata); // Avoid blocking Promise.all if this individual fetch takes too long
                      _context11.next = 6;
                      return sdkClientCommon.promiseWithTimeout(_this6.ipfs.fetchString(metadataCid), sdkClientCommon.MULTI_FETCH_TIMEOUT);
                    case 6:
                    ...
                    case 11:
                      ...
                      if (!(_context11.t0 instanceof sdkClientCommon.InvalidCidError)) {
                        _context11.next = 15;
                        break;
                      }
                      return _context11.abrupt("return", toAddresslistVotingProposalListItem(proposal, sdkClientCommon.UNSUPPORTED_PROPOSAL_METADATA_LINK));
                    case 15:
                      return _context11.abrupt("return", toAddresslistVotingProposalListItem(proposal, sdkClientCommon.UNAVAILABLE_PROPOSAL_METADATA));
                    case 16:
                    case "end":
                      return _context11.stop();
                  }
        ...
        while (1) switch (_context13.prev = _context13.next) {
          ...
          case 11:
            return _context13.abrupt("return", {
              ...
              supportThreshold: sdkClientCommon.decodeRatio(BigInt(addresslistVotingPlugin.supportThreshold), 6),
              minParticipation: sdkClientCommon.decodeRatio(BigInt(addresslistVotingPlugin.minParticipation), 6),
  ...
  function () {
    var _isMember = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee14$(_context14) {
        while (1) switch (_context14.prev = _context14.next) {
          case 0:
            sdkClientCommon.IsMemberSchema.strict().validateSync(params);
...
var AddresslistVotingClientEncoding = /*#__PURE__*/function (_ClientCore) {
  ...
  AddresslistVotingClientEncoding.getPluginInstallItem = function getPluginInstallItem(params, network) {
    ...
    var networkName = sdkClientCommon.getNetwork(network).name;
    var aragonNetwork = osxCommonsConfigs.getNetworkNameByAlias(networkName);
    if (!aragonNetwork) {
      throw new sdkClientCommon.UnsupportedNetworkError(networkName);
    }
    var hexBytes = abi.defaultAbiCoder.encode(sdkClientCommon.getNamedTypesFromMetadata(INSTALLATION_ABI$2), [votingSettingsToContract(params.votingSettings), params.addresses]);
    var repoAddress = (_contracts$aragonNetw = osxCommonsConfigs.contracts[aragonNetwork][osxCommonsConfigs.SupportedVersions.V1_3_0]) == null || (_contracts$aragonNetw = _contracts$aragonNetw.AddresslistVotingRepoProxy) == null ? void 0 : _contracts$aragonNetw.address;
    if (!repoAddress) {
...
var AddresslistVotingClientDecoding = /*#__PURE__*/function (_ClientCore) {
  ...
  _proto.findInterface = function findInterface(data) {
    try {
      var func = sdkClientCommon.getFunctionFragment(data, AVAILABLE_FUNCTION_SIGNATURES$2);
      return {
        id: func.format("minimal"),
        functionName: func.name,
        hash: sdkClientCommon.bytesToHex(data).substring(0, 10)
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            addresslistContract = osxEthers.AddresslistVoting__factory.connect(params.pluginAddress, provider);
            if (!((_params$failSafeActio = params.failSafeActions) != null && _params$failSafeActio.length && params.failSafeActions.length !== ((_params$actions = params.actions) == null ? void 0 : _params$actions.length))) {
              _context.next = 4;
              break;
            }
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return sdkClientCommon.prepareGenericUpdateEstimation(this.web3, this.graphql, _extends({}, params, {
              pluginSetupProcessorAddress: this.web3.getAddress(osxCommonsConfigs.FrameworkContractsNames.PLUGIN_SETUP_PROCESSOR),
              pluginRepo: this.web3.getAddress(osxCommonsConfigs.NonFrameworkContractsNames.ADDRESSLIST_VOTING_REPO_PROXY)
            }));
          case 2:
...
exports.UnwrapTokensStep = void 0;
...
var QueryTokenVotingProposal = /*#__PURE__*/graphqlRequest.gql(_templateObject$6 || (_templateObject$6 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery TokenVotingProposal($proposalId: ID!) {\n  tokenVotingProposal(id: $proposalId){\n    id\n    dao {\n      id\n      subdomain\n    }\n    creator\n    metadata\n    createdAt\n    creationBlockNumber\n    executionDate\n    executionBlockNumber\n    actions {\n      to\n      value\n      data\n    }\n    yes,\n    no,\n    abstain\n    votingMode\n    supportThreshold\n    startDate\n    endDate\n    executed\n    earlyExecutable\n    approvalReached\n    isSignaling\n    executionTxHash\n    voters(first: 1000){\n      voter{\n        address\n      }\n      voteReplaced\n      voteOption\n      votingPower\n    }\n    plugin {\n      token {\n        id\n        name\n        symbol\n        __typename\n        ...on ERC20Contract {\n          decimals\n        }\n        ...on ERC20WrapperContract {\n          decimals\n          underlyingToken{\n            id\n            name\n            symbol\n            decimals\n          }\n        }\n      }\n    }\n    totalVotingPower\n    minVotingPower\n  }\n}\n"])));
...
var QueryTokenVotingSettings = /*#__PURE__*/graphqlRequest.gql(_templateObject$5 || (_templateObject$5 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery TokenVotingSettings($address: ID!,$block: Block_height) {\n  tokenVotingPlugin(id: $address, block: $block){\n    minDuration\n    minProposerVotingPower\n    minParticipation\n    supportThreshold\n    votingMode\n  }\n}\n"])));

var _templateObject$4;
var QueryTokenVotingPlugin = /*#__PURE__*/graphqlRequest.gql(_templateObject$4 || (_templateObject$4 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery TokenVotingPlugin($address: ID!) {\n  tokenVotingPlugin(id: $address){\n    token {\n      id\n      name\n      symbol\n      __typename\n      ...on ERC20WrapperContract {\n        decimals\n        underlyingToken{\n          id\n          name\n          symbol\n          decimals\n        }\n      }\n      ...on ERC20Contract {\n        decimals\n      }\n    }\n  }\n}\n"])));

var _templateObject$3, _templateObject2$2;
var QueryTokenVotingMembers = /*#__PURE__*/graphqlRequest.gql(_templateObject$3 || (_templateObject$3 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery TokenVotingMembers($where: TokenVotingMember_filter!, $block: Block_height, $limit: Int!, $skip: Int!, $sortBy: TokenVotingMember_orderBy!, $direction: OrderDirection!) {\n  tokenVotingMembers(\n    where: $where\n    block: $block\n    first: $limit\n    skip: $skip\n    orderBy: $sortBy\n    orderDirection: $direction\n  ) {\n    address\n    balance\n    votingPower\n    delegatee{\n      address\n    }\n    delegators{\n      address\n      balance\n    }\n  }\n}\n"])));
var QueryTokenVotingIsMember = /*#__PURE__*/graphqlRequest.gql(_templateObject2$2 || (_templateObject2$2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery TokenVotingIsMember($id: ID!, $block: Block_height) {\n  tokenVotingMember(\n    id: $id\n    block: $block\n  ) {\n    id\n  }\n}"])));
...
function _isERC20Token() {
  _isERC20Token = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tokenAddress, signer) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          contract = new contracts.Contract(tokenAddress, ERC20_json.abi, signer);
          _context.prev = 1;
          _context.next = 4;
          return Promise.all([contract.balanceOf(constants.AddressZero), contract.decimals()]);
        case 4:
...
var AVAILABLE_FUNCTION_SIGNATURES$1 = [/*#__PURE__*/osxEthers.MajorityVotingBase__factory.createInterface().getFunction("updateVotingSettings").format("minimal"), /*#__PURE__*/osxEthers.IERC20MintableUpgradeable__factory.createInterface().getFunction("mint").format("minimal")];
// TODO:
// use abi from plugin metadata
var UPDATE_ABI$1 = {
  1: []
...
var ERC165_INTERFACE_ID = /*#__PURE__*/sdkClientCommon.getInterfaceId( /*#__PURE__*/new abi.Interface(ERC165_json.abi));
var GOVERNANCE_SUPPORTED_INTERFACE_IDS = [/*#__PURE__*/sdkClientCommon.getInterfaceId( /*#__PURE__*/new abi.Interface(IVotesUpgradeable_json.abi)), /*#__PURE__*/sdkClientCommon.getInterfaceId( /*#__PURE__*/new abi.Interface(IVotes_json.abi)), /*#__PURE__*/sdkClientCommon.getInterfaceId( /*#__PURE__*/osxEthers.IGovernanceWrappedERC20__factory.createInterface())];
...
var TokenVotingClientMethods = /*#__PURE__*/function (_ClientCore) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 14:
            ...
            log = sdkClientCommon.findLog(receipt, tokenVotingContractInterface, "ProposalCreated");
            if (log) {
              _context.next = 19;
              break;
            }
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            aragonNetwork = osxCommonsConfigs.getNetworkNameByAlias(networkName);
            if (aragonNetwork) {
              _context5.next = 7;
              break;
            }
          ...
          case 7:
            return _context5.delegateYield(_asyncGeneratorDelegate(_asyncIterator(sdkClientCommon.prepareGenericInstallation(_this4.web3, {
              daoAddressOrEns: params.daoAddressOrEns,
              pluginRepo: _this4.web3.getAddress(osxCommonsConfigs.NonFrameworkContractsNames.TOKEN_VOTING_REPO_PROXY),
              version: params.versionTag,
    ...
    return _wrapAsyncGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            return _context6.delegateYield(_asyncGeneratorDelegate(_asyncIterator(sdkClientCommon.prepareGenericUpdate(_this5.web3, _this5.graphql, _extends({}, params, {
              pluginRepo: _this5.web3.getAddress(osxCommonsConfigs.NonFrameworkContractsNames.TOKEN_VOTING_REPO_PROXY),
    ...
    var _canVote = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee12$(_context12) {
        while (1) switch (_context12.prev = _context12.next) {
          ...
          case 3:
            _decodeProposalId3 = sdkClientCommon.decodeProposalId(params.proposalId), pluginAddress = _decodeProposalId3.pluginAddress, id = _decodeProposalId3.id;
            tokenVotingContract = osxEthers.TokenVoting__factory.connect(pluginAddress, provider);
  ...
  function () {
    var _getMembers = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(_ref) {
      ...
      return _regeneratorRuntime().wrap(function _callee14$(_context14) {
        while (1) switch (_context14.prev = _context14.next) {
          case 0:
            pluginAddress = _ref.pluginAddress, blockNumber = _ref.blockNumber, _ref$limit = _ref.limit, limit = _ref$limit === void 0 ? 10 : _ref$limit, _ref$skip = _ref.skip, skip = _ref$skip === void 0 ? 0 : _ref$skip, _ref$direction = _ref.direction, direction = _ref$direction === void 0 ? sdkClientCommon.SortDirection.ASC : _ref$direction, _ref$sortBy = _ref.sortBy, sortBy = _ref$sortBy === void 0 ? TokenVotingMembersSortBy.VOTING_POWER : _ref$sortBy;
            if (address.isAddress(pluginAddress)) {
              _context14.next = 3;
              break;
            }
      ...
      return _regeneratorRuntime().wrap(function _callee15$(_context15) {
        while (1) switch (_context15.prev = _context15.next) {
          ...
          case 14:
            ...
            return _context15.abrupt("return", toTokenVotingProposal(tokenVotingProposal, sdkClientCommon.EMPTY_PROPOSAL_METADATA_LINK));
          case 16:
            _context15.prev = 16;
            metadataCid = sdkClientCommon.resolveIpfsCid(tokenVotingProposal.metadata);
            _context15.next = 20;
            return this.ipfs.fetchString(metadataCid);
          case 20:
          ...
          case 25:
            ...
            if (!(_context15.t0 instanceof sdkClientCommon.InvalidCidError)) {
              _context15.next = 29;
              break;
            }
            return _context15.abrupt("return", toTokenVotingProposal(tokenVotingProposal, sdkClientCommon.UNSUPPORTED_PROPOSAL_METADATA_LINK));
          case 29:
            return _context15.abrupt("return", toTokenVotingProposal(tokenVotingProposal, sdkClientCommon.UNAVAILABLE_PROPOSAL_METADATA));
          case 30:
          case "end":
            return _context15.stop();
        }
  ...
  function () {
    var _getProposals = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee17(_ref2) {
      var _this10 = this;
      var daoAddressOrEns, _ref2$limit, limit, status, _ref2$skip, skip, _ref2$direction, direction, _ref2$sortBy, sortBy, where, address$1, provider, resolvedAddress, query, params, name, _yield$this$graphql$r3, tokenVotingProposals;
      return _regeneratorRuntime().wrap(function _callee17$(_context17) {
        while (1) switch (_context17.prev = _context17.next) {
          case 0:
            daoAddressOrEns = _ref2.daoAddressOrEns, _ref2$limit = _ref2.limit, limit = _ref2$limit === void 0 ? 10 : _ref2$limit, status = _ref2.status, _ref2$skip = _ref2.skip, skip = _ref2$skip === void 0 ? 0 : _ref2$skip, _ref2$direction = _ref2.direction, direction = _ref2$direction === void 0 ? sdkClientCommon.SortDirection.ASC : _ref2$direction, _ref2$sortBy = _ref2.sortBy, sortBy = _ref2$sortBy === void 0 ? exports.ProposalSortBy.CREATED_AT : _ref2$sortBy;
                ...
                return _regeneratorRuntime().wrap(function _callee16$(_context16) {
                  while (1) switch (_context16.prev = _context16.next) {
                    case 0:
                      ...
                      return _context16.abrupt("return", toTokenVotingProposalListItem(proposal, sdkClientCommon.EMPTY_PROPOSAL_METADATA_LINK));
                    case 2:
                      _context16.prev = 2;
                      metadataCid = sdkClientCommon.resolveIpfsCid(proposal.metadata); // Avoid blocking Promise.all if this individual fetch takes too long
                      _context16.next = 6;
                      return sdkClientCommon.promiseWithTimeout(_this10.ipfs.fetchString(metadataCid), sdkClientCommon.MULTI_FETCH_TIMEOUT);
                    case 6:
                    ...
                    case 11:
                      ...
                      if (!(_context16.t0 instanceof sdkClientCommon.InvalidCidError)) {
                        _context16.next = 15;
                        break;
                      }
                      return _context16.abrupt("return", toTokenVotingProposalListItem(proposal, sdkClientCommon.UNSUPPORTED_PROPOSAL_METADATA_LINK));
                    case 15:
                      return _context16.abrupt("return", toTokenVotingProposalListItem(proposal, sdkClientCommon.UNAVAILABLE_PROPOSAL_METADATA));
                    case 16:
                    case "end":
                      return _context16.stop();
                  }
        ...
        while (1) switch (_context18.prev = _context18.next) {
          ...
          case 11:
            return _context18.abrupt("return", {
              ...
              supportThreshold: sdkClientCommon.decodeRatio(BigInt(tokenVotingPlugin.supportThreshold), 6),
              minParticipation: sdkClientCommon.decodeRatio(BigInt(tokenVotingPlugin.minParticipation), 6),
  ...
  function () {
    var _isTokenVotingCompatibleToken = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee20(tokenAddress) {
      ...
      return _regeneratorRuntime().wrap(function _callee20$(_context20) {
        while (1) switch (_context20.prev = _context20.next) {
          case 0:
            if (!(!address.isAddress(tokenAddress) || tokenAddress === constants.AddressZero)) {
              _context20.next = 2;
              break;
            }
            throw new sdkClientCommon.InvalidAddressError();
          ...
          case 5:
            ...
            throw new sdkClientCommon.NotAContractError();
          case 8:
            contract = new contracts.Contract(tokenAddress, ERC165_json.abi, provider);
            _context20.next = 11;
...
var TokenVotingClientEncoding = /*#__PURE__*/function (_ClientCore) {
  ...
  TokenVotingClientEncoding.getPluginInstallItem = function getPluginInstallItem(params, network) {
    ...
    var hexBytes = abi.defaultAbiCoder.encode(sdkClientCommon.getNamedTypesFromMetadata(INSTALLATION_ABI$1), args);
    var repoAddress = (_contracts$aragonNetw = osxCommonsConfigs.contracts[aragonNetwork][osxCommonsConfigs.SupportedVersions.V1_3_0]) == null || (_contracts$aragonNetw = _contracts$aragonNetw.TokenVotingRepoProxy) == null ? void 0 : _contracts$aragonNetw.address;
    if (!repoAddress) {
      throw new Error();
    }
    return {
...
var TokenVotingClientDecoding = /*#__PURE__*/function (_ClientCore) {
  ...
  _proto.findInterface = function findInterface(data) {
    try {
      var func = sdkClientCommon.getFunctionFragment(data, AVAILABLE_FUNCTION_SIGNATURES$1);
      return {
        id: func.format("minimal"),
        functionName: func.name,
        hash: sdkClientCommon.bytesToHex(data).substring(0, 10)
    ...
    var _createProposal = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            provider = this.web3.getConnectedSigner();
            tokenVotingContract = osxEthers.TokenVoting__factory.connect(params.pluginAddress, provider);
            if (!((_params$failSafeActio = params.failSafeActions) != null && _params$failSafeActio.length && params.failSafeActions.length !== ((_params$actions = params.actions) == null ? void 0 : _params$actions.length))) {
              _context.next = 4;
              break;
            }
    ...
    var _delegateTokens = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            provider = this.web3.getConnectedSigner();
            governanceErc20Contract = osxEthers.GovernanceERC20__factory.connect(params.tokenAddress, provider);
            _context4.next = 4;
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return sdkClientCommon.prepareGenericUpdateEstimation(this.web3, this.graphql, _extends({}, params, {
              pluginSetupProcessorAddress: this.web3.getAddress(osxCommonsConfigs.FrameworkContractsNames.PLUGIN_SETUP_PROCESSOR),
              pluginRepo: this.web3.getAddress(osxCommonsConfigs.NonFrameworkContractsNames.TOKEN_VOTING_REPO_PROXY)
            }));
          case 2:
...
exports.ApproveProposalStep = void 0;
...
var QueryMultisigProposal = /*#__PURE__*/graphqlRequest.gql(_templateObject$2 || (_templateObject$2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery MultisigProposal($proposalId: ID!) {\n  multisigProposal(id: $proposalId){\n    id\n    dao {\n      id\n      subdomain\n    }\n    creator\n    metadata\n    createdAt\n    startDate\n    endDate\n    actions {\n      to\n      value\n      data\n    }\n    executionDate\n    executionBlockNumber\n    creationBlockNumber\n    plugin {\n      onlyListed\n    }\n    minApprovals\n    executionTxHash\n    executed\n    approvalReached\n    isSignaling\n    approvals(first: 1000){\n      approver{\n        address\n      }\n    }\n  }\n}\n"])));
var QueryMultisigProposals = /*#__PURE__*/graphqlRequest.gql(_templateObject2$1 || (_templateObject2$1 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery MultisigProposals($where: MultisigProposal_filter!, $limit:Int!, $skip: Int!, $direction: OrderDirection!, $sortBy: MultisigProposal_orderBy!) {\n  multisigProposals(where: $where, first: $limit, skip: $skip, orderDirection: $direction, orderBy: $sortBy){\n    id\n    dao {\n      id\n      subdomain\n    }\n    creator\n    metadata\n    executed\n    approvalReached\n    isSignaling\n    approvalCount\n    startDate\n    endDate\n    executionDate\n    executionBlockNumber\n    creationBlockNumber\n    approvals(first: 1000){\n      approver{\n        address\n      }\n    }\n    actions {\n      to\n      value\n      data\n    }\n    minApprovals\n    plugin{\n      onlyListed\n    }\n  }\n}\n"])));

var _templateObject$1;
var QueryMultisigVotingSettings = /*#__PURE__*/graphqlRequest.gql(_templateObject$1 || (_templateObject$1 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery MultisigVotingSettings($address: ID!, $block: Block_height) {\n    multisigPlugin(id: $address, block: $block){\n        minApprovals\n        onlyListed\n    }\n}\n"])));

var _templateObject, _templateObject2;
var QueryMultisigMembers = /*#__PURE__*/graphqlRequest.gql(_templateObject || (_templateObject = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery MultisigMembers($where: MultisigApprover_filter!, $block: Block_height, $limit: Int!, $skip: Int!, $sortBy: MultisigApprover_orderBy!, $direction: OrderDirection!) {\n  multisigApprovers(\n    where: $where\n    block: $block\n    first: $limit\n    skip: $skip\n    orderBy: $sortBy\n    orderDirection: $direction\n  ) {\n    address\n    isActive\n  }\n}\n"])));
var QueryMultisigIsMember = /*#__PURE__*/graphqlRequest.gql(_templateObject2 || (_templateObject2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\nquery MultisigIsMember($id: ID!, $block: Block_height) {\n  multisigApprover(\n    id: $id\n    block: $block\n  ) {\n    id\n  }\n}"])));
...
var MultisigClientMethods = /*#__PURE__*/function (_ClientCore) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 14:
            ...
            log = sdkClientCommon.findLog(receipt, multisigContractInterface, "ProposalCreated");
            if (log) {
              _context.next = 19;
              break;
            }
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 7:
            return _context5.delegateYield(_asyncGeneratorDelegate(_asyncIterator(sdkClientCommon.prepareGenericInstallation(_this4.web3, {
              daoAddressOrEns: params.daoAddressOrEns,
              pluginRepo: _this4.web3.getAddress(osxCommonsConfigs.NonFrameworkContractsNames.MULTISIG_REPO_PROXY),
              version: params.versionTag,
    ...
    return _wrapAsyncGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            return _context6.delegateYield(_asyncGeneratorDelegate(_asyncIterator(sdkClientCommon.prepareGenericUpdate(_this5.web3, _this5.graphql, _extends({}, params, {
              pluginRepo: _this5.web3.getAddress(osxCommonsConfigs.NonFrameworkContractsNames.MULTISIG_REPO_PROXY),
    ...
    var _canApprove = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          ...
          case 3:
            _decodeProposalId3 = sdkClientCommon.decodeProposalId(params.proposalId), pluginAddress = _decodeProposalId3.pluginAddress, id = _decodeProposalId3.id;
            multisigContract = osxEthers.Multisig__factory.connect(pluginAddress, provider);
      ...
      return _regeneratorRuntime().wrap(function _callee11$(_context11) {
        while (1) switch (_context11.prev = _context11.next) {
          ...
          case 14:
            ...
            return _context11.abrupt("return", toMultisigProposal(multisigProposal, sdkClientCommon.EMPTY_PROPOSAL_METADATA_LINK));
          case 16:
            _context11.prev = 16;
            metadataCid = sdkClientCommon.resolveIpfsCid(multisigProposal.metadata);
            _context11.next = 20;
            return this.ipfs.fetchString(metadataCid);
          case 20:
          ...
          case 25:
            ...
            return _context11.abrupt("return", toMultisigProposal(multisigProposal, sdkClientCommon.UNSUPPORTED_PROPOSAL_METADATA_LINK));
          case 29:
            return _context11.abrupt("return", toMultisigProposal(multisigProposal, sdkClientCommon.UNAVAILABLE_PROPOSAL_METADATA));
          case 30:
          case "end":
            return _context11.stop();
        }
  ...
  function () {
    var _getProposals = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(_ref2) {
      var _this6 = this;
      var daoAddressOrEns, _ref2$limit, limit, status, _ref2$skip, skip, _ref2$direction, direction, _ref2$sortBy, sortBy, where, address$1, provider, resolvedAddress, query, params, name, _yield$this$graphql$r4, multisigProposals;
      return _regeneratorRuntime().wrap(function _callee13$(_context13) {
        while (1) switch (_context13.prev = _context13.next) {
          case 0:
            daoAddressOrEns = _ref2.daoAddressOrEns, _ref2$limit = _ref2.limit, limit = _ref2$limit === void 0 ? 10 : _ref2$limit, status = _ref2.status, _ref2$skip = _ref2.skip, skip = _ref2$skip === void 0 ? 0 : _ref2$skip, _ref2$direction = _ref2.direction, direction = _ref2$direction === void 0 ? sdkClientCommon.SortDirection.ASC : _ref2$direction, _ref2$sortBy = _ref2.sortBy, sortBy = _ref2$sortBy === void 0 ? exports.ProposalSortBy.CREATED_AT : _ref2$sortBy;
                ...
                return _regeneratorRuntime().wrap(function _callee12$(_context12) {
                  while (1) switch (_context12.prev = _context12.next) {
                    case 0:
                      ...
                      return _context12.abrupt("return", toMultisigProposalListItem(proposal, sdkClientCommon.EMPTY_PROPOSAL_METADATA_LINK));
                    case 2:
                      _context12.prev = 2;
                      metadataCid = sdkClientCommon.resolveIpfsCid(proposal.metadata); // Avoid blocking Promise.all if this individual fetch takes too long
                      _context12.next = 6;
                    ...
                    case 11:
                      ...
                      if (!(_context12.t0 instanceof sdkClientCommon.InvalidCidError)) {
                        _context12.next = 15;
                        break;
                      }
                      return _context12.abrupt("return", toMultisigProposalListItem(proposal, sdkClientCommon.UNSUPPORTED_PROPOSAL_METADATA_LINK));
                    case 15:
                      return _context12.abrupt("return", toMultisigProposalListItem(proposal, sdkClientCommon.UNAVAILABLE_PROPOSAL_METADATA));
                    case 16:
                    case "end":
                      return _context12.stop();
                  }
...
var MultisigClientEncoding = /*#__PURE__*/function (_ClientCore) {
  ...
  MultisigClientEncoding.getPluginInstallItem = function getPluginInstallItem(params, network) {
    ...
    var hexBytes = abi.defaultAbiCoder.encode(sdkClientCommon.getNamedTypesFromMetadata(INSTALLATION_ABI), [params.members, [params.votingSettings.onlyListed, params.votingSettings.minApprovals]]);
    var repoAddress = (_contracts$aragonNetw = osxCommonsConfigs.contracts[aragonNetwork][osxCommonsConfigs.SupportedVersions.V1_3_0]) == null || (_contracts$aragonNetw = _contracts$aragonNetw.MultisigRepoProxy) == null ? void 0 : _contracts$aragonNetw.address;
    if (!repoAddress) {
      throw new Error("AddresslistVotingRepoProxy address not found");
    }
    return {
...
var MultisigClientDecoding = /*#__PURE__*/function (_ClientCore) {
  ...
  _proto.findInterface = function findInterface(data) {
    try {
      var func = sdkClientCommon.getFunctionFragment(data, AVAILABLE_FUNCTION_SIGNATURES);
      return {
        id: func.format("minimal"),
        functionName: func.name,
        hash: sdkClientCommon.bytesToHex(data).substring(0, 10)
    ...
    var _createProposal = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(params) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            provider = this.web3.getConnectedSigner();
            multisigContract = osxEthers.Multisig__factory.connect(params.pluginAddress, provider);
            if (!((_params$failSafeActio = params.failSafeActions) != null && _params$failSafeActio.length && params.failSafeActions.length !== ((_params$actions = params.actions) == null ? void 0 : _params$actions.length))) {
              _context.next = 4;
              break;
            }
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return sdkClientCommon.prepareGenericUpdateEstimation(this.web3, this.graphql, _extends({}, params, {
              pluginSetupProcessorAddress: this.web3.getAddress(osxCommonsConfigs.FrameworkContractsNames.PLUGIN_SETUP_PROCESSOR),
              pluginRepo: this.web3.getAddress(osxCommonsConfigs.NonFrameworkContractsNames.MULTISIG_REPO_PROXY)
            }));
          case 2:
            return _context4.abrupt("return", _context4.sent);
          case 3:
...
Object.defineProperty(exports, 'Context', {
  enumerable: true,
  get: function () { return sdkClientCommon.Context; }
});
Object.defineProperty(exports, 'PermissionIds', {
  enumerable: true,
  get: function () { return sdkClientCommon.PermissionIds; }
});
Object.defineProperty(exports, 'Permissions', {
  enumerable: true,
  get: function () { return sdkClientCommon.Permissions; }
});
Object.defineProperty(exports, 'PrepareInstallationStep', {
  enumerable: true,
  get: function () { return sdkClientCommon.PrepareInstallationStep; }
});
Object.defineProperty(exports, 'PrepareUpdateStep', {
  enumerable: true,
  get: function () { return sdkClientCommon.PrepareUpdateStep; }
});
...
exports.applyInstallatonParamsFromContract = applyInstallatonParamsFromContract;
...
exports.isFailingProposal = isFailingProposal;
