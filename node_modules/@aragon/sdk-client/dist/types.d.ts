import { MetadataAbiInput, MultiTargetPermission, Pagination, PluginInstallItem, TokenType } from "@aragon/sdk-client-common";
...
export type DepositParams = DepositEthParams | DepositErc20Params | DepositErc721Params | DepositErc1155Params;
export declare enum DaoDepositSteps {
    CHECKED_ALLOWANCE = "checkedAllowance",
    DEPOSITING = "depositing",
    DONE = "done"
}
export type DaoDepositStepValue = SetAllowanceStepValue | {
...
export type WithdrawParams = WithdrawEthParams | WithdrawErc20Params | WithdrawErc721Params | WithdrawErc1155Params;
...
export type AssetBalance = NativeAssetBalance | Erc20AssetBalance | Erc721AssetBalance | Erc1155AssetBalance;
...
export type Deposit = (NativeTokenTransfer | Erc20TokenTransfer | Erc721TokenTransfer | Erc1155TokenTransfer) & {
    type: TransferType.DEPOSIT;
};
export type Withdraw = (NativeTokenTransfer | Erc20TokenTransfer | Erc721TokenTransfer | Erc1155TokenTransfer) & {
...
export declare enum ProposalSettingsErrorCause {
...
export declare enum PluginUpdateProposalInValidityCause {
...
export declare enum DaoUpdateProposalInvalidityCause {
...
export declare enum PluginPreparationType {
    INSTALLATION = "Installation",
    UPDATE = "Update",
    UNINSTALLATION = "Uninstallation"
}
export declare enum PluginPreparationSortBy {
    ID = "id"
}
