...
import { NetworkDeployment, NetworkDeployments, SupportedVersions } from './types';
/**
 ...
 */
export declare function getNetworkDeployments(network: SupportedNetworks): NetworkDeployments;
/**
 ...
 */
export declare function getNetworkDeploymentForVersion(network: SupportedNetworks, version: SupportedVersions): NetworkDeployment | null;
/**
 ...
 */
export declare function getLatestNetworkDeployment(network: SupportedNetworks): NetworkDeployment | null;
export declare function getDaoEnsDomain(networkName: SupportedNetworks): string | undefined;
export declare function getPluginEnsDomain(networkName: SupportedNetworks): string | undefined;
